import{c as St}from"./vendor-vue-DkdC8wD7.js";import{c as gt}from"./feature-isochrone-DpHm_RMw.js";import{c as mt,a as xt,b as bt,d as ft}from"./feature-poi-00WTd6eB.js";import{c as vt,a as Mt,b as Rt,d as Pt}from"./feature-history-B8s66fJP.js";import{a as kt,c as wt}from"./feature-h3-DvNLCYT3.js";import{c as At,u as _t,a as Lt,b as Ct,d as Tt,e as Dt,f as Nt,g as It,A as Ot,h as Ft,i as Et,j as $t,k as Bt,l as Wt,m as Gt}from"./feature-stores-f-A93-w7.js";import{a as Ht,c as zt}from"./feature-export-Ci3zhuiQ.js";import{a as Vt,b as rt,d as ot,c as lt,e as dt,f as jt,g as qt}from"./feature-road-map-CAYi7MCF.js";import{m as st,u as pt,v as Kt,x as Ut,y as at,z as it,A as Yt,B as Zt,C as Qt,d as ct}from"./vendor-C18lXgnW.js";(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const h of document.querySelectorAll('link[rel="modulepreload"]'))d(h);new MutationObserver(h=>{for(const u of h)if(u.type==="childList")for(const v of u.addedNodes)v.tagName==="LINK"&&v.rel==="modulepreload"&&d(v)}).observe(document,{childList:!0,subtree:!0});function o(h){const u={};return h.integrity&&(u.integrity=h.integrity),h.referrerPolicy&&(u.referrerPolicy=h.referrerPolicy),h.crossOrigin==="use-credentials"?u.credentials="include":h.crossOrigin==="anonymous"?u.credentials="omit":u.credentials="same-origin",u}function d(h){if(h.ep)return;h.ep=!0;const u=o(h);fetch(h.href,u)}})();const ht=new Map,Xt="analysis-style-";function yt(r){const l=ht.get(r);if(l)return l;const o=new Promise((d,h)=>{const u=document.querySelector(`script[data-analysis-src="${r}"]`);if(u){if(u.__loaded){d();return}u.addEventListener("load",()=>d(),{once:!0}),u.addEventListener("error",()=>h(new Error(`script load failed: ${r}`)),{once:!0});return}const v=document.createElement("script");v.src=r,v.async=!1,v.dataset.analysisSrc=r,v.onload=()=>{v.__loaded=!0,d()},v.onerror=()=>h(new Error(`script load failed: ${r}`)),document.head.appendChild(v)});return ht.set(r,o),o}function nt(r){const l=`${Xt}${r}`.replace(/[^a-zA-Z0-9_-]/g,"_");if(document.getElementById(l))return;const o=document.createElement("link");o.id=l,o.rel="stylesheet",o.href=r,document.head.appendChild(o)}async function Jt(){nt("/static/css/map-common.css"),nt("/static/css/filter-panel.css"),nt("/static/css/analysis-page.css"),await yt("/static/vendor/html2canvas.min.js"),await yt("/static/vendor/echarts.min.js")}const te=`
        ...
        <aside class="sidebar">
            ...
            <div class="sidebar-content">
                ...
                <div v-show="sidebarView === 'wizard'" style="display:contents;">
                    ...
                    <!-- Step 2: Results & Filter -->
                    <div v-show="step === 2" class="wizard-step wizard-step-step3">
                            ...
                            <div class="panel-area panel-area-fill">
                                <div class="panel poi-panel" v-show="activeStep3Panel === 'poi'">
                                    <div class="poi-panel-topbar">
                                        <div class="h3-subtabs h3-stage-tabs poi-stage-tabs">
                                            <button type="button" class="h3-subtab-pill h3-stage-pill"
                                                :class="{ active: poiSubTab === 'load' }"
                                                @click="setPoiSubTab('load')">抓取</button>
                                            <button type="button" class="h3-subtab-pill h3-stage-pill"
                                            ...
                                            <button type="button" class="h3-subtab-pill h3-stage-pill"
                                                :class="{ active: poiSubTab === 'grid' }"
                                                @click="setPoiSubTab('grid')">网格</button>
                                        </div>
                                        <div class="poi-panel-header" v-show="poiSubTab !== 'grid'">
                                        ...
                                        <div v-if="poiSubTab !== 'grid' && shouldShowPoiPanelStatus()" class="poi-panel-status" :class="{ 'is-loading': isHistoryPoiRestoring() }">
                                            <span v-if="isHistoryPoiRestoring()" class="poi-panel-status-dot"></span>
                                            <span>{{ getPoiPanelStatusText() }}</span>
                                        </div>
                                    </div>
                                    <div v-show="poiSubTab === 'load'" class="poi-subpanel">
                                        ...
                                        <button class="btn-black" :disabled="isFetchingPois" @click="fetchPois">
                                            {{ isFetchingPois ? '数据抓取中 ' + fetchProgress + '%' : '开始抓取 POI' }}
                                        </button>
                                    ...
                                    <div v-show="poiSubTab === 'category'" class="poi-subpanel">
                                        <p class="step-desc">按分类查看与筛选已加载的 POI</p>
                                ...
                                <div class="poi-subpanel poi-grid-subpanel" v-show="poiSubTab === 'grid'">
...
`,ee=`
        ...
        <main class="main-content">
            <div v-if="sidebarView === 'wizard' && step === 2" class="h3-map-toolbar">
                ...
                <div class="h3-simplify-wrap">
                    <button type="button" class="h3-map-tool-btn h3-map-simplify-btn"
                        ...
                        <span class="h3-map-tool-text">显示</span>
            ...
            <div v-if="sidebarView === 'wizard' && step === 2 && h3ExportTasksOpen" class="h3-export-task-panel">
            ...
            <div v-if="sidebarView === 'wizard' && step === 2 && h3Toast.message"
