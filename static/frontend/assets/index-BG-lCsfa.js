import{c as pt}from"./vendor-vue-DkdC8wD7.js";import{c as St}from"./feature-isochrone-CoKIAalb.js";import{c as gt,a as xt,b as mt,d as bt}from"./feature-poi-Jfq-YZAz.js";import{c as ft,a as vt,b as Mt,d as Rt}from"./feature-history-DNhBmJ_9.js";import{a as kt,c as Pt}from"./feature-h3-CVHZCJ-S.js";import{a as wt,c as _t}from"./feature-export-uqKfP_7R.js";import{a as At,b as st,d as rt,c as ot,e as lt,f as Lt,g as Ct}from"./feature-road-map-CTSBP9_i.js";import{c as Tt,u as Nt,a as It,b as Dt,d as Ot,e as Ft,A as Et,f as $t,g as Bt,h as Wt,i as zt}from"./feature-stores-DUsOBFrN.js";import{m as it,u as yt,v as Gt,x as Ht,y as et,z as at,A as jt,B as Vt,C as qt,d as dt}from"./vendor-C18lXgnW.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))h(c);new MutationObserver(c=>{for(const g of c)if(g.type==="childList")for(const M of g.addedNodes)M.tagName==="LINK"&&M.rel==="modulepreload"&&h(M)}).observe(document,{childList:!0,subtree:!0});function l(c){const g={};return c.integrity&&(g.integrity=c.integrity),c.referrerPolicy&&(g.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?g.credentials="include":c.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function h(c){if(c.ep)return;c.ep=!0;const g=l(c);fetch(c.href,g)}})();const ct=new Map,Kt="analysis-style-";function ht(r){const o=ct.get(r);if(o)return o;const l=new Promise((h,c)=>{const g=document.querySelector(`script[data-analysis-src="${r}"]`);if(g){if(g.__loaded){h();return}g.addEventListener("load",()=>h(),{once:!0}),g.addEventListener("error",()=>c(new Error(`script load failed: ${r}`)),{once:!0});return}const M=document.createElement("script");M.src=r,M.async=!1,M.dataset.analysisSrc=r,M.onload=()=>{M.__loaded=!0,h()},M.onerror=()=>c(new Error(`script load failed: ${r}`)),document.head.appendChild(M)});return ct.set(r,l),l}function nt(r){const o=`${Kt}${r}`.replace(/[^a-zA-Z0-9_-]/g,"_");if(document.getElementById(o))return;const l=document.createElement("link");l.id=o,l.rel="stylesheet",l.href=r,document.head.appendChild(l)}async function Ut(){nt("/static/css/map-common.css"),nt("/static/css/filter-panel.css"),nt("/static/css/analysis-page.css"),await ht("/static/vendor/html2canvas.min.js"),await ht("/static/vendor/echarts.min.js")}const Yt=`
