import{c as pt}from"./vendor-vue-DkdC8wD7.js";import{c as St}from"./feature-isochrone-CoKIAalb.js";import{c as gt,a as mt,b as xt,d as bt}from"./feature-poi-Jfq-YZAz.js";import{c as ft,a as vt,b as Rt,d as Mt}from"./feature-history-AmbAqK7J.js";import{a as kt,c as Pt}from"./feature-h3-SknWQC-z.js";import{a as wt,c as At}from"./feature-export-Ci3zhuiQ.js";import{a as _t,b as st,d as rt,c as ot,e as lt,f as Lt,g as Ct}from"./feature-road-map-CTSBP9_i.js";import{c as Tt,u as Nt,a as Dt,b as It,d as Ot,e as Ft,A as Et,f as $t,g as Bt,h as Wt,i as Gt}from"./feature-stores-DsjQicvE.js";import{m as nt,u as yt,v as Ht,x as zt,y as et,z as at,A as jt,B as Vt,C as qt,d as dt}from"./vendor-C18lXgnW.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))h(c);new MutationObserver(c=>{for(const p of c)if(p.type==="childList")for(const v of p.addedNodes)v.tagName==="LINK"&&v.rel==="modulepreload"&&h(v)}).observe(document,{childList:!0,subtree:!0});function l(c){const p={};return c.integrity&&(p.integrity=c.integrity),c.referrerPolicy&&(p.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?p.credentials="include":c.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function h(c){if(c.ep)return;c.ep=!0;const p=l(c);fetch(c.href,p)}})();const ct=new Map,Kt="analysis-style-";function ht(r){const o=ct.get(r);if(o)return o;const l=new Promise((h,c)=>{const p=document.querySelector(`script[data-analysis-src="${r}"]`);if(p){if(p.__loaded){h();return}p.addEventListener("load",()=>h(),{once:!0}),p.addEventListener("error",()=>c(new Error(`script load failed: ${r}`)),{once:!0});return}const v=document.createElement("script");v.src=r,v.async=!1,v.dataset.analysisSrc=r,v.onload=()=>{v.__loaded=!0,h()},v.onerror=()=>c(new Error(`script load failed: ${r}`)),document.head.appendChild(v)});return ct.set(r,l),l}function it(r){const o=`${Kt}${r}`.replace(/[^a-zA-Z0-9_-]/g,"_");if(document.getElementById(o))return;const l=document.createElement("link");l.id=o,l.rel="stylesheet",l.href=r,document.head.appendChild(l)}async function Ut(){it("/static/css/map-common.css"),it("/static/css/filter-panel.css"),it("/static/css/analysis-page.css"),await ht("/static/vendor/html2canvas.min.js"),await ht("/static/vendor/echarts.min.js")}const Yt=`
        ...
        </main>`,Qt=`${Yt}${Zt}`,F=Object.freeze({POI:"poi",H3:"h3",H3_SETTINGS:"h3_settings",SYNTAX:"syntax"});function Jt(){return{normalizeStep3PanelId(r=""){const o=String(r||"");return o===F.H3_SETTINGS?F.H3:o},shouldShowPoiOnCurrentPanel(){return String(this.activeStep3Panel||"")===F.POI&&!this.poiSystemSuspendedForSyntax&&String(this.poiSubTab||"category")!=="analysis"},shouldShowPoiKdeOnCurrentPanel(){return String(this.activeStep3Panel||"")===F.POI&&!this.poiSystemSuspendedForSyntax&&String(this.poiSubTab||"")==="analysis"&&!!this.poiKdeEnabled},applyPoiFilterPanel(r=""){const o=this.filterPanel;if(!o||typeof o.applyFilters!="function")return Promise.resolve({ok:!1,skipped:!0,reason:"filter_panel_unavailable:"+String(r||"")});try{const l=o.applyFilters();return l&&typeof l.then=="function"?l:Promise.resolve({ok:!0,reason:"filter_panel_sync:"+String(r||"")})}catch(l){return Promise.resolve({ok:!1,reason:"filter_panel_exception:"+String(r||""),error:l&&l.message?l.message:String(l)})}},applySimplifyPointVisibility(){const r=this.shouldShowPoiOnCurrentPanel();typeof this.applyPoiVisualState=="function"&&this.applyPoiVisualState({shouldShowPoi:r}),!this.markerManager&&r&&Array.isArray(this.allPoisDetails)&&this.allPoisDetails.length>0&&this.rebuildPoiRuntimeSystem(this.allPoisDetails)},selectStep3Panel(r){if(this.isDraggingNav)return;const o=this.normalizeStep3PanelId(r);if(o===F.SYNTAX&&!this.roadSyntaxModulesReady){this.roadSyntaxSetStatus("路网模块未完整加载："+(this.roadSyntaxModuleMissing||[]).join(", "));return}if(!this.isStep3PanelVisible(o))return;const l=this.activeStep3Panel;if(this.activeStep3Panel=o,l===F.SYNTAX&&o!==F.SYNTAX&&this.suspendRoadSyntaxDisplay(),o!==F.H3&&(this.h3ExportMenuOpen=!1,this.h3ExportTasksOpen=!1),o===F.POI){this.applySimplifyPointVisibility(),this.$nextTick(()=>{String(this.poiSubTab||"category")==="analysis"?this.refreshPoiKdeOverlay():(this.updatePoiCharts(),setTimeout(()=>this.resizePoiChart(),0))});return}if(o===F.H3){this.syncH3PoiFilterSelection(!1),this.ensureH3PanelEntryState(),this.restoreH3GridDisplayOnEnter(),this.$nextTick(()=>{typeof this.updateH3Charts=="function"&&this.updateH3Charts(),typeof this.updateDecisionCards=="function"&&this.updateDecisionCards()}),this.applySimplifyPointVisibility();return}if(o===F.SYNTAX){if(!!this.roadSyntaxSummary||Array.isArray(this.roadSyntaxRoadFeatures)&&this.roadSyntaxRoadFeatures.length>0||Array.isArray(this.roadSyntaxNodes)&&this.roadSyntaxNodes.length>0){const c=typeof this.roadSyntaxMetricTabs=="function"?this.roadSyntaxMetricTabs().map(_=>_.value):["connectivity","control","depth","choice","integration","intelligibility"],p=String(this.roadSyntaxMainTab||"").trim(),v=String(this.roadSyntaxMetric||"").trim(),N=String(this.roadSyntaxLastMetricTab||"").trim(),w=typeof this.roadSyntaxDefaultMetric=="function"?this.roadSyntaxDefaultMetric():"connectivity",T=c.includes(p)?p:c.includes(v)?v:c.includes(N)?N:w;this.setRoadSyntaxMainTab(T,{refresh:!1,syncMetric:!0})}else this.setRoadSyntaxMainTab("params",{refresh:!1,syncMetric:!1});this.resumeRoadSyntaxDisplay()}this.applySimplifyPointVisibility()},suspendPoiSystemForSyntax(){this.poiSystemSuspendedForSyntax||(this.clearPoiOverlayLayers({reason:"suspend_for_syntax",clearManager:!0,clearSimpleMarkers:!0,resetFilterPanel:!0,immediate:!0}),this.poiSystemSuspendedForSyntax=!0)},resumePoiSystemAfterSyntax(){this.poiSystemSuspendedForSyntax&&(this.poiSystemSuspendedForSyntax=!1,!this.markerManager&&Array.isArray(this.allPoisDetails)&&this.allPoisDetails.length&&this.rebuildPoiRuntimeSystem(this.allPoisDetails))},onStep3DragStart(r,o){this.dragIndex=r,this.dragOverIndex=r,this.dragInsertPosition="before",this.isDraggingNav=!0,o&&o.dataTransfer&&(o.dataTransfer.effectAllowed="move")},onStep3DragOver(r,o){o&&o.preventDefault(),this.dragOverIndex=r;const l=o.currentTarget.getBoundingClientRect(),h=l.top+l.height/2;this.dragInsertPosition=o.clientY<h?"before":"after"},onStep3Drop(r){if(this.dragIndex===null){this.dragOverIndex=null,this.dragInsertPosition=null;return}const o=this.step3NavItems.slice(),l=o.splice(this.dragIndex,1)[0];let h=r;this.dragInsertPosition==="after"&&(h=r+1),this.dragIndex<h&&(h-=1),o.splice(h,0,l),this.step3NavItems=o,this.dragIndex=null,this.dragOverIndex=null,this.dragInsertPosition=null,this.isDraggingNav=!1},onStep3DragEnd(){this.dragIndex=null,this.dragOverIndex=null,this.dragInsertPosition=null,this.isDraggingNav=!1},goToStep(r){this.confirmNavigation(()=>{r<this.step&&(typeof this.cancelHistoryDetailLoading=="function"&&this.cancelHistoryDetailLoading(),this.step===3&&r<=2&&(this.clearPoiOverlayLayers({reason:"go_to_step_back_to_step2",clearManager:!0,clearSimpleMarkers:!0,resetFilterPanel:!0}),this.resetRoadSyntaxState(),this.poiStatus="",this.clearH3Grid()),this.step>=2&&r<=1&&(typeof this.clearScopePolygonsFromMap=="function"&&this.clearScopePolygonsFromMap(),this.resetRoadSyntaxState(),this.lastIsochroneGeoJSON=null,this.clearH3Grid())),this.step=r})},confirmNavigation(r){this.isFetchingPois?confirm("数据抓取正在进行中，离开将取消未完成的任务。确定要离开吗？")&&(this.cancelFetch(),r()):r()},cancelFetch(){this.abortController&&(this.abortController.abort(),this.abortController=null),this.isFetchingPois=!1,this.poiStatus="任务已取消",this.resetFetchSubtypeProgress()},backToHome(){this.confirmNavigation(()=>{this.destroyPlaceSearch(),this.clearAnalysisLayers(),this.sidebarView="start",this.step=1,this.selectedPoint=null,typeof this.clearCenterMarkerOverlay=="function"&&this.clearCenterMarkerOverlay(),this.errorMessage=""})}}}function Xt(){return{clearAnalysisLayers(){this.abortController&&(this.abortController.abort(),this.abortController=null),this.cancelHistoryDetailLoading(),this.isFetchingPois=!1,this.fetchProgress=0,this.poiStatus="",this.roadSyntaxStatus="",this.resetFetchSubtypeProgress(),this.allPoisDetails=[],this.poiSubTab="category",this.poiAnalysisSubTab="kde",this.poiKdeEnabled=!1,this.poiKdeStats=this.createEmptyPoiKdeStats(),this.scopeSource="",this.drawnScopePolygon=[],this.lastIsochroneGeoJSON=null,this.h3GridStatus="",this.h3GridCount=0,this.h3GridFeatures=[],this.isGeneratingGrid=!1,this.resetH3AnalysisState(),this.clearIsochroneDebugState(),this.clearPoiOverlayLayers({reason:"clear_analysis_layers",clearManager:!0,clearSimpleMarkers:!0,resetFilterPanel:!0}),this.clearPoiKdeOverlay(),this.resetRoadSyntaxState(),this.mapCore&&(this.mapCore.clearGridPolygons&&this.mapCore.clearGridPolygons(),this.mapCore.setRadius(0)),this.clearScopeOutlineDisplay(),this.stopScopeDrawing(),this.disposePoiChart()},resetAnalysis(){this.destroyPlaceSearch(),this.step=1,this.isochroneScopeMode="point",this.h3SimplifyMenuOpen=!1,this.h3SimplifyTargets=[],this.clearIsochroneDebugState(),this.sidebarView="wizard",this.selectedPoint=null,this.errorMessage="",this.marker&&(this.safeMapSet(this.marker,null),this.marker=null),this.clearAnalysisLayers(),this.mapCore&&this.mapCore.map&&this.mapCore.map.setFitView(),this.applySimplifyConfig()},saveAndRestart(){this.destroyPlaceSearch(),this.stopScopeDrawing(),this.cancelHistoryDetailLoading(),this.clearIsochroneDebugState(),this.step=1,this.activeStep3Panel="poi",this.isochroneScopeMode="point",this.h3SimplifyMenuOpen=!1,this.h3SimplifyTargets=[],this.poiSystemSuspendedForSyntax=!1,this.selectedPoint=null,this.errorMessage="",this.poiStatus="",this.allPoisDetails=[],this.poiSubTab="category",this.poiAnalysisSubTab="kde",this.poiKdeEnabled=!1,this.poiKdeStats=this.createEmptyPoiKdeStats(),this.resultDataSource=this.normalizePoiSource(this.poiDataSource,"local"),this.scopeSource="",this.drawnScopePolygon=[],this.lastIsochroneGeoJSON=null,this.h3ExportMenuOpen=!1,this.h3ToastTimer&&(clearTimeout(this.h3ToastTimer),this.h3ToastTimer=null),this.h3Toast={message:"",type:"info"},this.clearPoiOverlayLayers({reason:"save_and_restart",clearManager:!0,clearSimpleMarkers:!0,clearCenterMarker:!0,resetFilterPanel:!0}),this.clearPoiKdeOverlay(),this.clearH3Grid(),this.clearScopeOutlineDisplay(),this.disposePoiChart(),this.applySimplifyConfig()}}}function te(r,o=[]){return(Array.isArray(o)?o:[]).reduce((l,h)=>{const c=String(h||"").trim();return c&&(l[c]={get(){return r[c]},set(p){r[c]=p}}),l},{})}function ee(r=[]){return(Array.isArray(r)?r:[]).reduce((o,l)=>{if(!l||typeof l!="object")return o;const h=l.store,c=l.fieldKeys;return h?Object.assign(o,te(h,c)):o},{})}function ae(){return{clearScopePolygonsFromMap(){this.mapCore&&typeof this.mapCore.clearCustomPolygons=="function"&&this.mapCore.clearCustomPolygons()},clearCenterMarkerOverlay(){this.marker&&(this.safeMapSet(this.marker,null),this.marker=null)},applyPoiVisualState(r={}){const o=!!r.shouldShowPoi,l=!o;if(this.markerManager&&typeof this.markerManager.setHideAllPoints=="function"&&(this.pointLayersSuspendedForSyntax=!o,l&&typeof this.markerManager.destroyClusterers=="function"&&this.markerManager.destroyClusterers({immediate:!0}),typeof this.markerManager.setShowMarkers=="function"&&this.markerManager.setShowMarkers(o),this.markerManager.setHideAllPoints(l),this.applyPoiFilterPanel("simplify_visibility")),this.marker&&(l?this.safeMapSet(this.marker,null):this.selectedPoint&&this.mapCore&&this.mapCore.map&&this.safeMapSet(this.marker,this.mapCore.map)),Array.isArray(this.poiMarkers)&&this.poiMarkers.length>0){const h=this.poiMarkers.slice();this.poiMarkers=[],this.enqueuePoiMapWrite(()=>(h.forEach(c=>this.safeMapSet(c,null)),{ok:!0,hidden:h.length}),{key:"clear_stale_simple_markers",replaceExisting:!0,meta:{reason:"clear_stale_simple_markers",marker_count:h.length}})}}}}function ie(){return{attachAmapRuntimeErrorProbe(){if(this.amapRuntimeErrorListener||this.amapRuntimeRejectionListener)return;const r=(l={})=>{const h=this.markerManager,c=h&&h.typeClusterers&&typeof h.typeClusterers=="object"?Object.keys(h.typeClusterers).length:0,p=h&&Array.isArray(h.markers)?h.markers.length:0;return Object.assign({step:Number(this.step||0),panel:String(this.activeStep3Panel||""),poi_suspended_for_syntax:!!this.poiSystemSuspendedForSyntax,marker_manager_alive:!!h,marker_count:p,clusterer_count:c,road_active_layer:String(this.roadSyntaxActiveLayerKey||""),road_switch_in_progress:!!this.roadSyntaxSwitchInProgress,road_pool_ready:!!this.roadSyntaxPoolReady,road_map_write_queue_pending:Number(this.roadSyntaxMapWriteQueuePending||0)},l||{})},o=(l="",h="")=>{const c=String(l||"");return String(h||"").indexOf("maps?v=")>=0||c.indexOf("split")>=0||c.indexOf("Ud")>=0||c.indexOf("Pixel(NaN")>=0};this.amapRuntimeErrorListener=l=>{const h=l&&l.message?String(l.message):"",c=l&&l.filename?String(l.filename):"";o(h,c)&&console.error("[diag] amap runtime error",r({message:h,filename:c,lineno:Number(l&&l.lineno||0),colno:Number(l&&l.colno||0)}))},this.amapRuntimeRejectionListener=l=>{const h=l&&l.reason||"",c=h&&h.message?String(h.message):String(h||"");o(c,"")&&console.error("[diag] amap runtime rejection",r({reason:c}))},window.addEventListener("error",this.amapRuntimeErrorListener),window.addEventListener("unhandledrejection",this.amapRuntimeRejectionListener)},detachAmapRuntimeErrorProbe(){this.amapRuntimeErrorListener&&window.removeEventListener("error",this.amapRuntimeErrorListener),this.amapRuntimeRejectionListener&&window.removeEventListener("unhandledrejection",this.amapRuntimeRejectionListener),this.amapRuntimeErrorListener=null,this.amapRuntimeRejectionListener=null},async onBasemapSourceChange(){let o=["amap","osm","tianditu"].includes(this.basemapSource)?this.basemapSource:"amap";if(o==="tianditu"?await this.validateTiandituSource()||(this.tdtDiagCopyStatus=""):(this.tdtDiag=null,this.tdtDiagCopyStatus="",this.errorMessage&&this.errorMessage.indexOf("天地图")>=0&&(this.errorMessage="")),this.basemapSource=o,this.mapCore&&this.mapCore.setBasemapSource){const l=this.mapCore.setBasemapSource(o);o==="tianditu"&&l&&l.ok===!1?(this.tdtDiag={ok:!1,phase:"map-init",status:null,contentType:"",bodySnippet:l.message||"",reason:l.code||"wmts-layer-init-failed"},this.errorMessage="天地图 WMTS 图层初始化失败，请检查：Key 类型=Web JS，白名单包含 localhost/127.0.0.1（及端口）。"):o==="tianditu"&&l&&l.ok===!0&&this.errorMessage&&this.errorMessage.indexOf("天地图")>=0&&(this.errorMessage="")}this.applySimplifyConfig()},_toNumber(r,o=0){const l=Number(r);return Number.isFinite(l)?l:o},loadAMapScript(r,o){return new Promise((l,h)=>{if(window.AMap&&window.AMap.Map){l();return}window._AMapSecurityConfig={securityJsCode:o};const c=document.createElement("script");c.src=`https://webapi.amap.com/maps?v=1.4.15&key=${r}`,c.onload=l,c.onerror=h,document.head.appendChild(c)})},async probeTiandituTile(r=4500){const o=(this.config&&this.config.tianditu_key?String(this.config.tianditu_key):"").trim();if(!o)return{ok:!1,phase:"wmts-probe",status:null,contentType:"",bodySnippet:"",reason:"missing-key",url:""};const l=`https://t0.tianditu.gov.cn/vec_w/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=vec&STYLE=default&TILEMATRIXSET=w&FORMAT=tiles&TILEMATRIX=7&TILEROW=53&TILECOL=107&tk=${encodeURIComponent(o)}&_ts=${Date.now()}`,h=new AbortController,c=window.setTimeout(()=>h.abort(),r);try{const p=await fetch(l,{method:"GET",cache:"no-store",signal:h.signal}),v=String(p.headers.get("content-type")||"").toLowerCase(),N=this.isImageContentType(v);let w="";if(!N)try{w=this._trimText(await p.text(),300)}catch{w=""}const T=p.status,_=p.ok&&N;let D="ok";return _||(T===418?D="http-418":T>=500?D="http-5xx":T>=400?D="http-4xx":p.ok?D="non-image-response":D="http-error"),{ok:_,phase:"wmts-probe",status:T,contentType:v,bodySnippet:w,reason:D,url:l}}catch(p){return p&&p.name==="AbortError"?{ok:!1,phase:"wmts-probe",status:null,contentType:"",bodySnippet:"",reason:"timeout",url:l}:{ok:!1,phase:"wmts-probe",status:null,contentType:"",bodySnippet:this._trimText(p&&p.message?p.message:String(p),300),reason:"network-error",url:l}}finally{window.clearTimeout(c)}},async validateTiandituSource(){const r=await this.probeTiandituTile();return this.tdtDiag=r,this.tdtDiagCopyStatus="",r.ok?(this.errorMessage&&this.errorMessage.indexOf("天地图")>=0&&(this.errorMessage=""),!0):(r.reason==="missing-key"?this.errorMessage="未配置天地图 Key（TIANDITU_KEY）。":r.reason==="timeout"?this.errorMessage="天地图 WMTS 探测超时，请稍后重试（配置修改可能需要 5-10 分钟生效）。":r.reason==="http-418"?this.errorMessage="天地图 WMTS 探测被拦截（HTTP 418），请检查 Key 类型=Web JS，白名单包含 localhost/127.0.0.1（及端口）。":this.errorMessage=`天地图 WMTS 探测失败（${r.status||"NO_STATUS"}），请检查 Key 与白名单。`,!1)},isImageContentType(r){const o=String(r||"").toLowerCase();return o.indexOf("image/")>=0||o.indexOf("application/octet-stream")>=0},_trimText(r,o=300){const l=String(r||"");return l.length<=o?l:l.slice(0,o)+"..."},buildTdtDiagText(){if(!this.tdtDiag)return"";const r=[`ok=${this.tdtDiag.ok}`,`phase=${this.tdtDiag.phase||"-"}`,`reason=${this.tdtDiag.reason||"-"}`,`status=${this.tdtDiag.status===null||this.tdtDiag.status===void 0?"-":this.tdtDiag.status}`,`contentType=${this.tdtDiag.contentType||"-"}`];return this.tdtDiag.url&&r.push(`url=${this.tdtDiag.url}`),this.tdtDiag.bodySnippet&&r.push(`body=${this.tdtDiag.bodySnippet}`),r.join(`
`)},async copyTdtDiag(){const r=this.buildTdtDiagText();if(!r){this.tdtDiagCopyStatus="无可复制内容";return}try{await navigator.clipboard.writeText(r),this.tdtDiagCopyStatus="已复制"}catch(o){console.error(o),this.tdtDiagCopyStatus="复制失败，请手动复制"}},roadSyntaxAttachMapListeners(){const r=this.mapCore&&this.mapCore.map?this.mapCore.map:null;r&&(this.roadSyntaxDetachMapListeners(),this.roadSyntaxZoomStartListener=()=>{this.roadSyntaxMapInteracting=!0,this.isRoadSyntaxMetricViewActive()&&this.roadSyntaxEnterLowFidelityMode()},this.roadSyntaxMoveStartListener=()=>{this.roadSyntaxMapInteracting=!0,this.isRoadSyntaxMetricViewActive()&&this.roadSyntaxEnterLowFidelityMode()},this.roadSyntaxMoveEndListener=()=>{this.roadSyntaxMapInteracting=!1,this.isRoadSyntaxMetricViewActive()&&(this.scheduleRoadSyntaxViewportRefresh("moveend"),this.roadSyntaxLogOverlayHealth("moveend")),this.markerManager&&typeof this.markerManager.logCoordinateHealth=="function"&&this.markerManager.logCoordinateHealth("road-syntax:moveend")},this.roadSyntaxZoomListener=()=>{this.roadSyntaxMapInteracting=!1,this.isRoadSyntaxMetricViewActive()&&(this.scheduleRoadSyntaxViewportRefresh("zoomend"),this.roadSyntaxLogOverlayHealth("zoomend")),this.markerManager&&typeof this.markerManager.logCoordinateHealth=="function"&&this.markerManager.logCoordinateHealth("road-syntax:zoomend")},r.on("zoomstart",this.roadSyntaxZoomStartListener),r.on("movestart",this.roadSyntaxMoveStartListener),r.on("moveend",this.roadSyntaxMoveEndListener),r.on("zoomend",this.roadSyntaxZoomListener))},roadSyntaxDetachMapListeners(){const r=this.mapCore&&this.mapCore.map?this.mapCore.map:null;if(r&&this.roadSyntaxZoomListener)try{r.off("zoomend",this.roadSyntaxZoomListener)}catch{}if(r&&this.roadSyntaxZoomStartListener)try{r.off("zoomstart",this.roadSyntaxZoomStartListener)}catch{}if(r&&this.roadSyntaxMoveStartListener)try{r.off("movestart",this.roadSyntaxMoveStartListener)}catch{}if(r&&this.roadSyntaxMoveEndListener)try{r.off("moveend",this.roadSyntaxMoveEndListener)}catch{}this.roadSyntaxZoomListener=null,this.roadSyntaxZoomStartListener=null,this.roadSyntaxMoveStartListener=null,this.roadSyntaxMoveEndListener=null},initMap(){const r=new _t("container",{center:{lng:112.9388,lat:28.2282},zoom:13,zooms:[3,20],mapData:{},basemapSource:this.basemapSource,basemapMuted:!1,tiandituKey:this.config?this.config.tianditu_key:"",tiandituContainerId:"tianditu-container",onGridFeatureClick:o=>this.onH3GridFeatureClick(o)});r.initMap(),this.mapCore=nt(r),this.applySimplifyConfig(),this.basemapSource==="tianditu"&&r.lastBasemapError&&(this.tdtDiag={ok:!1,phase:"map-init",status:null,contentType:"",bodySnippet:r.lastBasemapError.message||"",reason:r.lastBasemapError.code||"wmts-layer-init-failed"},this.errorMessage="天地图 WMTS 图层初始化失败，请检查：Key 类型=Web JS，白名单包含 localhost/127.0.0.1（及端口）。"),r.map.on("click",o=>{this.sidebarView!=="wizard"||this.step!==1||this.isochroneScopeMode==="point"&&(this.drawScopeActive||this.setSelectedPoint(o.lnglat))}),this.roadSyntaxAttachMapListeners()}}}function ne(){return{cancelHistoryDetailLoading(){if(this.historyDetailAbortController){try{this.historyDetailAbortController.abort()}catch(r){console.warn("history detail abort failed",r)}this.historyDetailAbortController=null}this.historyDetailLoadToken+=1},buildHistoryH3ResultSnapshot(){const r=Array.isArray(this.h3AnalysisGridFeatures)?this.h3AnalysisGridFeatures:[],o=Array.isArray(this.h3GridFeatures)?this.h3GridFeatures:[],l=r.length?r:o;if(!(l.length>0||!!this.h3AnalysisSummary))return null;const c=Number(this.h3GridCount);return{grid:{type:"FeatureCollection",features:l,count:Number.isFinite(c)?c:l.length,resolution:Number(this.h3GridResolution)||10,include_mode:String(this.h3GridIncludeMode||"intersects"),min_overlap_ratio:Number(this.h3GridMinOverlapRatio)||0},summary:this.h3AnalysisSummary||null,charts:this.h3AnalysisCharts||null,ui:{main_stage:String(this.h3MainStage||"params"),sub_tab:String(this.h3SubTab||"metric_map"),metric_view:String(this.h3MetricView||"density"),structure_fill_mode:String(this.h3StructureFillMode||"gi_z"),panel_active:this.activeStep3Panel==="h3"}}},buildHistoryRoadResultSnapshot(){const r=Array.isArray(this.roadSyntaxRoadFeatures)?this.roadSyntaxRoadFeatures:[],o=Array.isArray(this.roadSyntaxNodes)?this.roadSyntaxNodes:[];return r.length>0||o.length>0||!!this.roadSyntaxSummary?{summary:this.roadSyntaxSummary||null,diagnostics:this.roadSyntaxDiagnostics||null,roads:{type:"FeatureCollection",features:r,count:r.length},nodes:{type:"FeatureCollection",features:o,count:o.length},webgl:this.roadSyntaxWebglPayload||null,ui:{graph_model:String(this.roadSyntaxGraphModel||"segment"),main_tab:String(this.roadSyntaxMainTab||"params"),metric:String(this.roadSyntaxMetric||"connectivity"),radius_label:String(this.roadSyntaxRadiusLabel||"global"),color_scale:String(this.roadSyntaxDepthmapColorScale||"axmanesque"),display_blue:Number(this.roadSyntaxDisplayBlue)||0,display_red:Number(this.roadSyntaxDisplayRed)||1,panel_active:this.activeStep3Panel==="syntax"}}:null},saveAnalysisHistoryAsync(r,o,l){if(!this.selectedPoint)return;const c=(Array.isArray(o)?o:typeof this.buildSelectedCategoryBuckets=="function"?this.buildSelectedCategoryBuckets():[]).map(b=>b.name).join(","),p=this.isochroneScopeMode==="area"&&Array.isArray(this.drawnScopePolygon)&&this.drawnScopePolygon.length>=3?this._closePolygonRing(this.normalizePath(this.drawnScopePolygon,3,"history.drawn_polygon")):null,N=(Array.isArray(l)?l:Array.isArray(this.allPoisDetails)?this.allPoisDetails:[]).map(b=>({id:b&&b.id?String(b.id):"",name:b&&b.name?String(b.name):"未命名",location:Array.isArray(b&&b.location)?[b.location[0],b.location[1]]:null,address:b&&b.address?String(b.address):"",type:b&&b.type?String(b.type):"",adname:b&&b.adname?String(b.adname):"",lines:Array.isArray(b&&b.lines)?b.lines:[]})).filter(b=>Array.isArray(b.location)&&b.location.length===2),w=Array.isArray(r)&&r.length?r:this.getIsochronePolygonPayload(),T=this.buildHistoryH3ResultSnapshot(),_=this.buildHistoryRoadResultSnapshot(),D={center:[this.selectedPoint.lng,this.selectedPoint.lat],polygon:w,drawn_polygon:Array.isArray(p)&&p.length>=4?p:null,pois:N,keywords:c,location_name:this.selectedPoint.lng.toFixed(4)+","+this.selectedPoint.lat.toFixed(4),mode:this.transportMode,time_min:parseInt(this.timeHorizon),source:this.normalizePoiSource(this.resultDataSource||this.poiDataSource,"local"),h3_result:T,road_result:_};setTimeout(()=>{fetch("/api/v1/analysis/history/save",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(D)}).then(async b=>{if(!b.ok){let O="";try{O=await b.text()||""}catch{}throw new Error(`HTTP ${b.status}${O?`: ${O.slice(0,200)}`:""}`)}return b.json().catch(()=>({}))}).then(()=>{typeof this.loadHistoryList=="function"&&this.loadHistoryList({force:!0,keepExisting:!0,background:!0,hardRefresh:!0}).catch(b=>{console.warn("refresh history list after save failed",b)})}).catch(b=>{console.warn("Failed to save history",b);const O=b&&b.message?b.message:String(b);this.poiStatus=`分析完成，但历史保存失败：${O}`})},0)}}}function se(){return{}}function re(){return{async fetchPois(){if(this.lastIsochroneGeoJSON){this.isFetchingPois=!0,this.fetchProgress=0,this.poiStatus="准备抓取...",this.resetRoadSyntaxState(),this.resetFetchSubtypeProgress(),this.clearPoiOverlayLayers({reason:"fetch_pois_start",clearManager:!0,clearSimpleMarkers:!0,resetFilterPanel:!0}),this.allPoisDetails=[];try{const r=this.getIsochronePolygonPayload(),o=this.buildSelectedCategoryBuckets();if(o.length===0){alert("请至少选择一个分类"),this.isFetchingPois=!1;return}let l=0;const h=o.length,c=[];o[0]&&this.updateFetchSubtypeProgressDisplay(o[0]),this.abortController=new AbortController;const p=4,v=this.getPoiSourceLabel(this.poiDataSource);this.poiStatus=`正在并行抓取 ${h} 个分类（每批 ${p} 个，${v}）...`,this.resultDataSource=this.normalizePoiSource(this.poiDataSource,"local");const N=async w=>{const T={polygon:r,keywords:"",types:String(w.types||""),source:this.poiDataSource,save_history:!1,center:[this.selectedPoint.lng,this.selectedPoint.lat],time_min:parseInt(this.timeHorizon),mode:this.transportMode,location_name:this.selectedPoint.name||this.selectedPoint.lng.toFixed(4)+","+this.selectedPoint.lat.toFixed(4)};try{const _=await fetch("/api/v1/analysis/pois",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(T),signal:this.abortController.signal});if(!_.ok){let b="";try{b=await _.text()}catch{}return{list:[],error:`HTTP ${_.status}${b?` ${b.slice(0,240)}`:""}`}}return{list:(await _.json()).pois||[],error:""}}catch(_){return _.name!=="AbortError"&&console.warn(`Failed to fetch category ${w.name}`,_),{list:[],error:_&&_.message?String(_.message):String(_)}}};for(let w=0;w<o.length;w+=p){if(this.abortController.signal.aborted)return;const T=o.slice(w,w+p);(await Promise.all(T.map(N))).forEach((b,O)=>{const E=Array.isArray(b&&b.list)?b.list:[];E&&E.length&&this.allPoisDetails.push(...E);const $=T[O];$&&b&&b.error&&c.push({category:$.name||$.id||`cat_${w+O+1}`,error:b.error}),$&&this.accumulateFetchSubtypeHits($,E||[])}),l=this.allPoisDetails.length;const D=Math.min(w+T.length,h);this.fetchProgress=Math.round(D/h*100),this.poiStatus=`已完成 ${D}/${h} 分类，累计 ${l} 个结果`}if(this.abortController.signal.aborted)return;if(this.allPoisDetails=this.deduplicateFetchedPois(this.allPoisDetails),l=this.allPoisDetails.length,this.fetchProgress=100,l===0&&c.length>0){const w=c[0];throw new Error(`本地源请求失败（${c.length}/${h} 分类）。示例：${w.category} -> ${w.error}`)}this.poiStatus=`完成！共找到 ${l} 个结果`,c.length>0&&(console.warn("[poi-fetch] partial category failures",c),this.poiStatus+=`（${c.length} 个分类失败，已输出到控制台）`),this.rebuildPoiRuntimeSystem(this.allPoisDetails),setTimeout(()=>{this.step=3,this.activeStep3Panel="poi",this.updatePoiCharts(),this.resizePoiChart()},120),this.saveAnalysisHistoryAsync(r,o,this.allPoisDetails)}catch(r){r.name!=="AbortError"&&(console.error(r),this.poiStatus=`失败: ${r.message}`)}finally{this.isFetchingPois=!1,this.abortController=null,this.resetFetchSubtypeProgress()}}},computePoiStats(r){const o=this.poiCategories.map(p=>p.name),l=this.poiCategories.map(p=>p.color||"#888"),h=this.poiCategories.map(()=>0),c={};return this.poiCategories.forEach((p,v)=>{c[p.id]=v}),(r||[]).forEach(p=>{const v=this.resolvePoiCategoryId(p&&p.type);if(!v)return;const N=c[v];Number.isInteger(N)&&N>=0&&(h[N]+=1)}),{labels:o,colors:l,values:h}},getPoiCategoryChartStats(){const r=Array.isArray(this.allPoisDetails)&&this.allPoisDetails.length?this.allPoisDetails:this.markerManager&&typeof this.markerManager.getVisiblePoints=="function"?this.markerManager.getVisiblePoints():[];return this.computePoiStats(r)},updatePoiCharts(){if(!Array.isArray(this.allPoisDetails)||!this.allPoisDetails.length)return;if(this.activeStep3Panel==="poi"&&this.poiSubTab!=="category"){this.refreshPoiKdeOverlay();return}const r=document.getElementById("poiChart");if(!r||!window.echarts)return;const o=echarts.getInstanceByDom(r);if(o&&r.clientWidth>0){this.poiChart=o;const l=this.getPoiCategoryChartStats(),h=l.values.map(p=>Number.isFinite(p)?p:0),c={yAxis:{type:"category",inverse:!0,data:l.labels},series:[{data:h,itemStyle:{color:p=>l.colors[p.dataIndex]||"#888"}}]};o.setOption(c,!1),this.refreshPoiKdeOverlay();return}setTimeout(()=>{const l=this.initPoiChart();if(!l)return;const h=this.getPoiCategoryChartStats(),c=h.values.map(v=>Number.isFinite(v)?v:0),p={grid:{left:50,right:20,top:10,bottom:10,containLabel:!0},xAxis:{type:"value",axisLine:{show:!1},axisTick:{show:!1},splitLine:{lineStyle:{color:"#eee"}}},yAxis:{type:"category",inverse:!0,data:h.labels,axisLine:{show:!1},axisTick:{show:!1}},series:[{type:"bar",data:c,barWidth:12,itemStyle:{color:v=>h.colors[v.dataIndex]||"#888"}}]};try{l.setOption(p,!0),l.resize()}catch(v){console.error("ECharts setOption error:",v)}this.refreshPoiKdeOverlay()},100)}}}function oe(){return Object.freeze({SWITCH_TARGET_MS:120,PREBUILD_DEADLINE_MS:12e4,CONNECTIVITY_NODE_MIN_ZOOM:15,SWITCH_SAMPLE_LIMIT:40,BUILD_BUDGET_MS:Object.freeze({interacting:.8,init:6,steady:4,lineFallbackSmall:12,lineFallbackLarge:8,node:6.5})})}function le(r={}){const o=r&&r.typeMapConfig||{groups:[]},l=oe(),h=Jt(),c=Xt(),p=St(),v=()=>bt(),N=()=>xt(),w=mt(),T=gt(),_=()=>Rt(),D=()=>Mt(),b=vt(),O=ft(),E=()=>Pt(),$=kt(),z=()=>At(),j=wt(),V=st(l),q=lt(),K=rt(l),U=Ct(),Y=()=>ot(l),Z=ie(),Q=ne(),J=se(),W=re(),X=ae(),t=Object.freeze({queue:typeof Lt=="function",overlayCommit:typeof lt=="function",state:typeof ot=="function",controller:typeof rt=="function",ui:typeof st=="function"}),e=Object.keys(t).filter(m=>!t[m]),i=e.length===0;i||console.error("[road-syntax] module wiring incomplete",{missing:e.slice(),static_version:"frontend-build"});const a=pt(),n=Tt(a,{typeMapConfig:o,roadSyntaxModulesReady:i,roadSyntaxModuleMissing:e.slice(),buildAnalysisPoiRuntimeInitialState:N,buildAnalysisPoiInitialState:v,buildAnalysisHistoryListInitialState:_,buildAnalysisHistoryInitialState:D,buildAnalysisH3InitialState:E,buildAnalysisExportInitialState:z,buildRoadSyntaxInitialState:Y}),s=Nt(a),d=Dt(a),u=It(a),y=Ot(a),g=Ft(a),S=ee([{store:s,fieldKeys:Et},{store:d,fieldKeys:$t},{store:u,fieldKeys:Bt},{store:y,fieldKeys:Wt},{store:g,fieldKeys:Gt}]);return{pinia:a,initialState:n,storeBackedComputed:S,roadSyntaxModulesReady:i,roadSyntaxModuleMissing:e,methods:{analysisWorkbenchMethods:h,analysisWorkbenchSessionMethods:c,isochroneMethods:p,poiPanelMethods:w,poiRuntimeMethods:T,historyListMethods:b,historyMethods:O,h3Methods:$,exportMethods:j,roadSyntaxOverlayCommitMethods:q,roadSyntaxControllerCoreMethods:K,roadSyntaxWebglMethods:U,roadSyntaxUiMethods:V,mapOrchestratorMethods:Z,historyOrchestratorMethods:Q,exportOrchestratorMethods:J,poiFlowOrchestratorMethods:W,poiMapVisibilityAdapterMethods:X}}}function de({app:r,pinia:o,target:l="#analysis-app-root"}){if(!r||typeof r.use!="function"||typeof r.mount!="function")throw new Error("invalid app instance for runtime mount");if(!o)throw new Error("pinia instance is required for runtime mount");r.use(o),r.mount(l)}function ce(r={}){const o=!!r.roadSyntaxModulesReady,l=Array.isArray(r.roadSyntaxModuleMissing)?r.roadSyntaxModuleMissing:[];return{async mounted(){try{this.config=window.__ANALYSIS_BOOTSTRAP__&&window.__ANALYSIS_BOOTSTRAP__.config?window.__ANALYSIS_BOOTSTRAP__.config:{amap_js_api_key:"",amap_js_security_code:"",tianditu_key:""},this.initializePoiCategoriesFromTypeMap(),this.basemapSource==="tianditu"&&(await this.validateTiandituSource()||(this.tdtDiagCopyStatus=""));const h=8e3;await Promise.race([this.loadAMapScript(this.config.amap_js_api_key,this.config.amap_js_security_code),new Promise((c,p)=>setTimeout(()=>p(new Error("AMap 加载超时，请检查网络或 Key")),h))]),this.initMap()}catch(h){console.error("Initialization Failed:",h),this.errorMessage="系统初始化失败: "+h.message}finally{this.preloadHistoryListInBackground(),o||this.roadSyntaxSetStatus(`路网模块未完整加载：${l.join(", ")}`),this.attachAmapRuntimeErrorProbe(),document.addEventListener("click",this.handleGlobalClick,!0),this.loadingConfig=!1;const h=document.getElementById("loading-overlay");h&&(h.style.display="none")}},beforeUnmount(){document.removeEventListener("click",this.handleGlobalClick,!0),this.detachAmapRuntimeErrorProbe(),this.destroyPlaceSearch(),this.stopScopeDrawing({destroyTool:!0}),this.clearPoiOverlayLayers({reason:"before_unmount",clearManager:!0,clearSimpleMarkers:!0,clearCenterMarker:!0,resetFilterPanel:!0,immediate:!0}),this.clearPoiKdeOverlay(),this.roadSyntaxDetachMapListeners(),typeof this.cancelRoadSyntaxRequest=="function"&&this.cancelRoadSyntaxRequest("before_unmount"),this.invalidateRoadSyntaxCache("unmount",{resetData:!0}),this.h3ToastTimer&&(clearTimeout(this.h3ToastTimer),this.h3ToastTimer=null),this.cancelHistoryLoading(),this.cancelHistoryDetailLoading(),this.disposePoiChart(),this.disposeH3Charts()},watch:{step(h,c){c===1&&h!==1&&(this.destroyPlaceSearch(),this.stopScopeDrawing())},sidebarView(h,c){c==="history"&&h!=="history"&&this.cancelHistoryLoading(),c==="wizard"&&h!=="wizard"&&this.stopScopeDrawing()},activeStep3Panel(h,c){h!==c&&(h==="syntax"?typeof this.resumeRoadSyntaxDisplay=="function"&&this.resumeRoadSyntaxDisplay():typeof this.suspendRoadSyntaxDisplay=="function"&&this.suspendRoadSyntaxDisplay(),h==="syntax"?this.suspendPoiSystemForSyntax():c==="syntax"&&this.resumePoiSystemAfterSyntax(),c==="h3"&&h!=="h3"&&this.clearH3GridDisplayOnLeave(),h==="h3"&&this.restoreH3GridDisplayOnEnter(),this.$nextTick(()=>{this.refreshPoiKdeOverlay()}))},roadSyntaxGraphModel(h,c){const p=String(h||"").trim().toLowerCase(),v=String(c||"").trim().toLowerCase();!v||p===v||this.roadSyntaxSetStatus(`图模型已切换为${this.roadSyntaxGraphModelLabel(p)}，请重新计算路网指标`)}}}}function he(){const r=window.__ANALYSIS_BOOTSTRAP__&&window.__ANALYSIS_BOOTSTRAP__.typeMapConfig||{groups:[]},o=le({typeMapConfig:r}),{pinia:l,initialState:h,storeBackedComputed:c,roadSyntaxModulesReady:p,roadSyntaxModuleMissing:v,methods:N}=o,{analysisWorkbenchMethods:w,analysisWorkbenchSessionMethods:T,isochroneMethods:_,poiPanelMethods:D,poiRuntimeMethods:b,historyListMethods:O,historyMethods:E,h3Methods:$,exportMethods:z,roadSyntaxOverlayCommitMethods:j,roadSyntaxControllerCoreMethods:V,roadSyntaxWebglMethods:q,roadSyntaxUiMethods:K,mapOrchestratorMethods:U,historyOrchestratorMethods:Y,exportOrchestratorMethods:Z,poiFlowOrchestratorMethods:Q,poiMapVisibilityAdapterMethods:J}=N,W=ce({roadSyntaxModulesReady:p,roadSyntaxModuleMissing:v}),X=yt({data(){return{loadingConfig:!0,config:null,...h,placeSearch:null,placeSearchErrorListener:null,placeSearchLoadingPromise:null,placeSearchBuildToken:0,drawScopeMouseTool:null,drawScopeDrawHandler:null,drawScopeActive:!1,amapRuntimeErrorListener:null,amapRuntimeRejectionListener:null}},computed:c,mounted:W.mounted,beforeUnmount:W.beforeUnmount,watch:W.watch,methods:{...w,...T,..._,...D,...b,...O,...E,...$,...z,...J,...U,...Y,...Z,...Q,...j,...V,...q,...K,async generateH3Grid(){if(!(!this.getIsochronePolygonRing()||this.isGeneratingGrid||this.isComputingH3Analysis)){this.isGeneratingGrid=!0,this.resetH3AnalysisState(),this.h3GridStatus="正在生成网络...";try{const e=this.getIsochronePolygonPayload(),i=await fetch("/api/v1/analysis/h3-grid",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({polygon:e,resolution:this.h3GridResolution,coord_type:"gcj02",include_mode:this.h3GridIncludeMode,min_overlap_ratio:this.h3GridIncludeMode==="intersects"?this.h3GridMinOverlapRatio:0})});if(!i.ok){let s="";try{s=await i.text()}catch{}throw new Error(s||"网络生成失败")}const a=await i.json();this.h3GridFeatures=a.features||[],this.h3GridCount=Number.isFinite(a.count)?a.count:this.h3GridFeatures.length,this.isH3PanelActive()&&this.mapCore&&this.mapCore.setGridFeatures?this.mapCore.setGridFeatures(this.h3GridFeatures,{strokeColor:"#2c6ecb",strokeWeight:1.1,fillOpacity:0,webglBatch:!0}):this.clearH3GridDisplayOnLeave();const n=this.h3GridCount>0?`已生成 ${this.h3GridCount} 个 H3 网格`:"已生成网络，但当前范围无可用网格";this.h3GridStatus=this.isH3PanelActive()?n:`${n}（已就绪，切换到“网格”查看）`}catch(e){console.error(e),this.h3GridStatus="网络生成失败: "+e.message}finally{this.isGeneratingGrid=!1}}},isRoadSyntaxPanelActive(){return this.activeStep3Panel==="syntax"},isRoadSyntaxMetricViewActive(){return this.isRoadSyntaxPanelActive()&&this.roadSyntaxMainTab!=="params"},roadSyntaxMap(){return this.mapCore&&this.mapCore.map?this.mapCore.map:null},roadSyntaxQuantizeChannel(t,e=24){const i=Number.isFinite(Number(t))?Number(t):0,a=Math.max(1,Number(e)||1);return Math.max(0,Math.min(255,Math.round(i/a)*a))},roadSyntaxQuantizeHexColor(t="",e=24){const i=String(t||"").trim(),a=i.startsWith("#")?i.slice(1):i;if(!/^[0-9a-fA-F]{6}$/.test(a))return"#9ca3af";const n=this.roadSyntaxQuantizeChannel(parseInt(a.slice(0,2),16),e),s=this.roadSyntaxQuantizeChannel(parseInt(a.slice(2,4),16),e),d=this.roadSyntaxQuantizeChannel(parseInt(a.slice(4,6),16),e);return`#${n.toString(16).padStart(2,"0")}${s.toString(16).padStart(2,"0")}${d.toString(16).padStart(2,"0")}`},roadSyntaxNormalizeLayerStyleForBucket(t=null){const e=t||{},i=Math.max(1,Number(this.roadSyntaxStyleBucketColorStep||24)),a=Math.max(.1,Number(this.roadSyntaxStyleBucketWeightStep||.5)),n=Math.max(.02,Number(this.roadSyntaxStyleBucketOpacityStep||.08)),s=Number(e.strokeWeight),d=Number(e.strokeOpacity),u=Number(e.zIndex);return{strokeColor:this.roadSyntaxQuantizeHexColor(e.strokeColor||"#9ca3af",i),strokeWeight:Math.max(1,Math.round((Number.isFinite(s)?s:1.8)/a)*a),strokeOpacity:Math.max(.08,Math.min(1,Math.round((Number.isFinite(d)?d:.32)/n)*n)),zIndex:Number.isFinite(u)?Math.round(u):90}},roadSyntaxBuildLayerStyleBucketKey(t=null){const e=this.roadSyntaxNormalizeLayerStyleForBucket(t);return`${e.strokeColor}|${e.strokeWeight}|${e.strokeOpacity}|${e.zIndex}`},roadSyntaxCloneIndexSet(t=null){const e={};return Object.keys(t&&typeof t=="object"?t:{}).forEach(a=>{const n=Number(a);!Number.isFinite(n)||n<0||(e[n]=!0)}),e},roadSyntaxBuildLayerLodIndexSet(t=""){const e=String(t||""),i=Object.assign({},this.roadSyntaxLayerLodIndexCache||{});if(i[e])return this.roadSyntaxCloneIndexSet(i[e]);const a=Array.isArray(this.roadSyntaxPolylineItems)?this.roadSyntaxPolylineItems:[];if(!a.length)return{};const n=this.parseRoadSyntaxLayerKey(e),s=n.metric||this.resolveRoadSyntaxActiveMetric(),d=n.radiusLabel||"global",u=this.resolveRoadSyntaxMetricField(s,d),y=this.resolveRoadSyntaxFallbackField(s),g=this.resolveRoadSyntaxRankField(s),S=[];for(let k=0;k<a.length;k+=1){const R=a[k]||{};if((Array.isArray(R.coords)?R.coords:[]).length<2)continue;const A=R.props||{},L=Number(g?A[g]:NaN),P=Number(A[u]),C=Number(A[y]),I=Number.isFinite(L)?this.clamp01(L):Number.isFinite(P)?this.clamp01(P):Number.isFinite(C)?this.clamp01(C):0;S.push({idx:k,score:I})}if(!S.length)return{};S.sort((k,R)=>R.score-k.score||k.idx-R.idx);const m=Math.max(80,Math.floor(Number(this.roadSyntaxLayerLodCap||180))),x=[];if(S.length<=m)S.forEach(k=>x.push(k.idx));else{const k=Math.max(1,Math.min(m,Math.floor(m*.75)));for(let f=0;f<k;f+=1)x.push(S[f].idx);const R=m-x.length;if(R>0){const f=S.slice(k),A=f.length/R;for(let L=0;L<R;L+=1){const P=Math.min(f.length-1,Math.floor(L*A));x.push(f[P].idx)}}}const M={};return x.forEach(k=>{const R=Number(k);!Number.isFinite(R)||R<0||(M[R]=!0)}),i[e]=M,this.roadSyntaxLayerLodIndexCache=i,this.roadSyntaxCloneIndexSet(M)},roadSyntaxResolveDesiredLayerVariant(){const t=Array.isArray(this.roadSyntaxPolylineItems)?this.roadSyntaxPolylineItems.length:0;if(!t||typeof this.roadSyntaxResolveLodPolicy!="function")return"full";const e=this.roadSyntaxResolveLodPolicy(t);return e&&e.backboneOnly?"lod":"full"},roadSyntaxResolveLayerRuntimeEntry(t=null,e="full"){const i=String(e||"full"),a=t&&typeof t=="object"?t:null;return a?i==="lod"&&a.lodLayer&&Array.isArray(a.lodLayer.overlays)&&a.lodLayer.overlays.length?a.lodLayer:a:null},roadSyntaxApplyVisibleIndexSet(t={},e=""){const i=this.roadSyntaxCloneIndexSet(t);this.roadSyntaxTargetVisibleLineSet=Object.assign({},i),this.roadSyntaxAppliedVisibleLineSet=Object.assign({},i),this.roadSyntaxOverlayCommitToken=Number(this.roadSyntaxOverlayCommitToken||0)+1,this.roadSyntaxOverlayLastCommitPath="pool_state_apply",this.roadSyntaxOverlayLastCommitReason=String(e||"switch")},roadSyntaxDisposeLayerEntry(t=null,e=null){if(!t)return;const i=e||this.roadSyntaxMap();t.overlayGroup&&this.roadSyntaxSetOverlayGroupVisible(t.overlayGroup,!1,i);const a=Array.isArray(t.overlays)?t.overlays:[];a.length&&this.roadSyntaxSetLinesVisible(a,!1,i,{preferBatch:!0}),t.lodLayer&&this.roadSyntaxDisposeLayerEntry(t.lodLayer,i)},roadSyntaxBuildLayerFromStyles(t="",e=[],i={}){const a=Array.isArray(this.roadSyntaxPolylineItems)?this.roadSyntaxPolylineItems:[],n=i&&i.includeIndexSet&&typeof i.includeIndexSet=="object"?i.includeIndexSet:null,s=String(i&&i.variant||"full"),d=Number(i&&i.zIndexBoost||0),u=Object.create(null);let y=0;const g={};let S=0,m=0;const x=[];for(let f=0;f<a.length;f+=1){if(n&&!n[f])continue;const A=a[f]||{},L=Array.isArray(A.coords)?A.coords:[];if(L.length<2)continue;y+=1,g[f]=!0;const P=this.roadSyntaxNormalizeLayerStyleForBucket(e[f]||null),C=d?Object.assign({},P,{zIndex:(Number(P.zIndex)||90)+d}):P,I=this.roadSyntaxBuildLayerStyleBucketKey(C);u[I]||(u[I]={style:C,paths:[]}),u[I].paths.push(L)}const M=[],k=Object.values(u);k.forEach(f=>{const A=f.style||{},L=Array.isArray(f.paths)?f.paths:[];if(!L.length||!window.AMap)return;const P=[];L.forEach((C,I)=>{const G=this.normalizePath(C,2,"road_syntax.layer_build.path");if(!G.length){S+=1,x.length<5&&x.push({layer_key:String(t||""),variant:String(s||""),path_index:I,sample:this.roadSyntaxSummarizeCoordInput(Array.isArray(C)?C[0]:C)});return}P.push(G)}),P.length&&P.forEach(C=>{try{const I=nt(new AMap.Polyline({path:C,strokeColor:A.strokeColor||"#9ca3af",strokeWeight:Number(A.strokeWeight)||1.8,strokeOpacity:Number(A.strokeOpacity)||.32,zIndex:Number(A.zIndex)||90,bubble:!0,clickable:!1,cursor:"default"}));M.push(I)}catch{m+=1}})}),(S>0||m>0)&&console.warn("[road-syntax] layer build skipped invalid paths",{layer_key:String(t||""),variant:String(s||""),invalid_path_count:S,polyline_create_error_count:m,sample_paths:x});let R=null;try{window.AMap&&typeof AMap.OverlayGroup=="function"&&M.length&&(R=nt(new AMap.OverlayGroup(M)))}catch{R=null}return{layerKey:String(t||""),mode:"bucket_pool",variant:s,overlays:M,overlayGroup:R,bucketCount:k.length,featureCount:y,indexSet:g}},roadSyntaxGetLayer(t=""){const e=this.roadSyntaxLayerPool||{},i=String(t||"");return i&&e[i]||null},roadSyntaxSetStatus(t=""){this.roadSyntaxStatus=String(t||"")},cancelRoadSyntaxRequest(t=""){const e=this.roadSyntaxFetchAbortController;if(!e)return!1;try{e.abort()}catch{}return this.roadSyntaxFetchAbortController=null,t&&console.info("[road-syntax] request aborted",{reason:String(t||"")}),!0},roadSyntaxCreateRunId(){const t=Math.random().toString(36).slice(2,10);return`rs_${Date.now()}_${t}`},roadSyntaxStopProgressTracking(){this.roadSyntaxProgressPollTimer&&(window.clearInterval(this.roadSyntaxProgressPollTimer),this.roadSyntaxProgressPollTimer=null),this.roadSyntaxProgressTickTimer&&(window.clearInterval(this.roadSyntaxProgressTickTimer),this.roadSyntaxProgressTickTimer=null),this.roadSyntaxProgressPolling=!1},roadSyntaxResetProgressState(){this.roadSyntaxStopProgressTracking(),this.roadSyntaxProgressRunId="",this.roadSyntaxProgressStage="",this.roadSyntaxProgressMessage="",this.roadSyntaxProgressStep=0,this.roadSyntaxProgressTotal=0,this.roadSyntaxProgressElapsedSec=0,this.roadSyntaxProgressStartedAtMs=0},async roadSyntaxPollProgressOnce(t=null){const e=String(this.roadSyntaxProgressRunId||"").trim();if(e&&!this.roadSyntaxProgressPolling&&!(t!==null&&t!==this.roadSyntaxRequestToken)){this.roadSyntaxProgressPolling=!0;try{const i=await fetch(`/api/v1/analysis/road-syntax/progress?run_id=${encodeURIComponent(e)}`,{cache:"no-store"});if(!i.ok)return;const a=await i.json(),n=String(a&&a.stage||""),s=String(a&&a.message||""),d=String(a&&a.status||"running"),u=Number(a&&a.step),y=Number(a&&a.total),g=Number(a&&a.elapsed_sec);if(this.roadSyntaxProgressStage=n,this.roadSyntaxProgressMessage=s,this.roadSyntaxProgressStep=Number.isFinite(u)?Math.max(0,Math.floor(u)):0,this.roadSyntaxProgressTotal=Number.isFinite(y)?Math.max(0,Math.floor(y)):0,Number.isFinite(g)&&g>=0&&(this.roadSyntaxProgressElapsedSec=g),s){const m=this.roadSyntaxProgressStep>0&&this.roadSyntaxProgressTotal>0?`进度 ${this.roadSyntaxProgressStep}/${this.roadSyntaxProgressTotal}：${s}`:s;this.roadSyntaxSetStatus(m)}d!=="running"&&this.roadSyntaxStopProgressTracking()}catch{}finally{this.roadSyntaxProgressPolling=!1}}},roadSyntaxStartProgressTracking(t,e=null,i="已提交计算请求"){this.roadSyntaxStopProgressTracking(),this.roadSyntaxProgressRunId=String(t||"").trim(),this.roadSyntaxProgressStage="queued",this.roadSyntaxProgressMessage=String(i||""),this.roadSyntaxProgressStep=0,this.roadSyntaxProgressTotal=9,this.roadSyntaxProgressStartedAtMs=Date.now(),this.roadSyntaxProgressElapsedSec=0,i&&this.roadSyntaxSetStatus(i),this.roadSyntaxProgressRunId&&(this.roadSyntaxProgressTickTimer=window.setInterval(()=>{if(!this.isComputingRoadSyntax||!this.roadSyntaxProgressStartedAtMs)return;const a=Math.max(0,Math.floor((Date.now()-this.roadSyntaxProgressStartedAtMs)/1e3));this.roadSyntaxProgressElapsedSec=a},1e3),this.roadSyntaxProgressPollTimer=window.setInterval(()=>{this.roadSyntaxPollProgressOnce(e)},1e3),this.roadSyntaxPollProgressOnce(e))},roadSyntaxUseLegacyPoolStatus(){return!1},roadSyntaxLogOverlayHealth(t="",e={}){const i=!!(e&&e.force),a=Math.max(0,Number(e&&e.throttleMs||1200)),n=this.roadSyntaxNow(),s=Number(this._roadSyntaxOverlayHealthLastAt||0);if(!i&&n-s<a)return null;if(this._roadSyntaxOverlayHealthLastAt=n,this.roadSyntaxUseArcgisWebgl&&this.roadSyntaxWebglActive&&this.roadSyntaxWebglPayload){const x=Number(((this.roadSyntaxWebglPayload||{}).roads||{}).count||0);return(i||x<=0)&&console.info("[road-syntax] overlay pool health",{reason:String(t||""),active_layer:String(this.roadSyntaxActiveLayerKey||""),visible_lines:x,applied_visible_lines:x,target_visible_lines:x,total_lines:x,mode:"arcgis_webgl"}),{inspectedLines:x,visibleLines:x,invalid:{path:0,endpoint:0,line:0},totalLines:x}}const d=this.roadSyntaxAppliedVisibleLineSet&&typeof this.roadSyntaxAppliedVisibleLineSet=="object"?this.roadSyntaxAppliedVisibleLineSet:{},u=this.roadSyntaxTargetVisibleLineSet&&typeof this.roadSyntaxTargetVisibleLineSet=="object"?this.roadSyntaxTargetVisibleLineSet:{},y=Array.isArray(this.roadSyntaxPolylineItems)?this.roadSyntaxPolylineItems.length:0,g=Object.keys(d).length,S=Object.keys(u).length,m=g>0?g:this.roadSyntaxActiveLayerKey?y:0;return(i||m<=0)&&console.info("[road-syntax] overlay pool health",{reason:String(t||""),active_layer:String(this.roadSyntaxActiveLayerKey||""),visible_lines:m,applied_visible_lines:g,target_visible_lines:S,total_lines:y,mode:"bucket_pool"}),{inspectedLines:m,visibleLines:m,invalid:{path:0,endpoint:0,line:0},totalLines:y}},invalidateRoadSyntaxCache(t="manual",e={}){const i=!!(e&&e.resetData),a=!!(e&&e.resetPerf);if(typeof this.roadSyntaxClearMapWriteQueue=="function"&&this.roadSyntaxClearMapWriteQueue({dispose:t==="unmount"}),this.roadSyntaxStyleUpdateToken+=1,this.roadSyntaxPoolWarmToken+=1,this.roadSyntaxLayerBuildToken+=1,this.roadSyntaxLayerSwitchToken+=1,this.roadSyntaxPrewarmToken+=1,this.roadSyntaxStyleApplyToken+=1,this.roadSyntaxSwitchInProgress=!1,this.roadSyntaxSwitchQueuedLayerKey="",this.roadSyntaxSwitchLastAt=0,this.roadSyntaxClearSwitchThrottleTimer(),this.roadSyntaxClearViewportRefreshHandles(),this.roadSyntaxClearNodeRefreshTimer(),this.roadSyntaxBumpViewportRefreshToken(),this._roadSyntaxPinnedAttachKey="",this._roadSyntaxViewportToggleDisabledLogged=!1,this.roadSyntaxOverlayCommitToken=0,this.roadSyntaxOverlayLastCommitPath="",this.roadSyntaxOverlayLastCommitReason="",this.roadSyntaxInteractionLowFidelity=!1,this.roadSyntaxDisplaySuspended=!1,this.clearRoadSyntaxLayerPool(),this.roadSyntaxPolylines=[],this.roadSyntaxPolylineItems=[],this.roadSyntaxResetVisibleIndexCache(),this.roadSyntaxResetLodScoreCache(),this.roadSyntaxResetSpatialIndex(),this.roadSyntaxSourceFingerprint="",this.roadSyntaxPoolRadiusLabel="",this.roadSyntaxLastStyleKey="",this.roadSyntaxConnectivityReuseLayerKey="",this.roadSyntaxNodeBuildToken+=1,this.roadSyntaxNodeBuildRunning=!1,this.roadSyntaxNodeSourceFingerprint="",this.clearRoadSyntaxNodeMarkers({immediate:!0}),this.disposeRoadSyntaxScatterChart(),this.roadSyntaxWebglPayload=null,this.roadSyntaxWebglStatus="",this.roadSyntaxWebglRadiusFilterCache=null,typeof this.clearRoadSyntaxArcgisWebgl=="function"&&this.clearRoadSyntaxArcgisWebgl({dispose:t==="unmount"}),i){this.roadSyntaxStatus="",this.roadSyntaxSummary=null,this.roadSyntaxRoadFeatures=[],this.roadSyntaxNodes=[],this.roadSyntaxDiagnostics=null,this.roadSyntaxScatterPointsCache=[],this.roadSyntaxLegendModel=null,this.roadSyntaxSkeletonOnly=!1,this.roadSyntaxMainTab="params";const n=this.roadSyntaxDefaultMetric();this.roadSyntaxMetric=n,this.roadSyntaxLastMetricTab=n,this.roadSyntaxRadiusLabel="global"}a&&(this.roadSyntaxSwitchSamples=[],this.roadSyntaxSwitchLastMs=0,this.roadSyntaxSwitchP50Ms=0,this.roadSyntaxSwitchP95Ms=0,this.roadSyntaxSwitchStatsText="",this.roadSyntaxSwitchPath=""),t==="unmount"&&(this.roadSyntaxStatus="")},resetRoadSyntaxState(){this.roadSyntaxRequestToken+=1,this.isComputingRoadSyntax=!1,this.roadSyntaxResetProgressState(),this.invalidateRoadSyntaxCache("reset-state",{resetData:!0,resetPerf:!0})},clearRoadSyntaxOverlays(){this.invalidateRoadSyntaxCache("clear-overlays",{resetData:!1,resetPerf:!1})},suspendRoadSyntaxDisplay(){const t=this.roadSyntaxMap();if(!t)return;this.roadSyntaxDisplaySuspended=!0,this.roadSyntaxLayerSwitchToken+=1,this.roadSyntaxClearViewportRefreshHandles(),this.roadSyntaxClearNodeRefreshTimer(),this.roadSyntaxBumpViewportRefreshToken(),this._roadSyntaxPinnedAttachKey="",this.roadSyntaxInteractionLowFidelity=!1;const e=this.roadSyntaxGetLayer(this.roadSyntaxActiveLayerKey||""),i=this.roadSyntaxResolveLayerRuntimeEntry(e,this.roadSyntaxActiveLayerVariant||"full");i&&(i.overlayGroup?this.roadSyntaxSetOverlayGroupVisible(i.overlayGroup,!1,t):Array.isArray(i.overlays)&&i.overlays.length&&this.roadSyntaxSetLinesVisible(i.overlays,!1,t,{preferBatch:!0})),this.roadSyntaxResetVisibleIndexCache(),this.roadSyntaxCurrentStride=1,typeof this.setRoadSyntaxArcgisWebglVisible=="function"&&this.setRoadSyntaxArcgisWebglVisible(!1),this.cancelRoadSyntaxNodeBuild(),this.setRoadSyntaxNodeMarkersVisible(!1),this.disposeRoadSyntaxScatterChart()},resumeRoadSyntaxDisplay(){if(!this.roadSyntaxSummary||!Array.isArray(this.roadSyntaxRoadFeatures)||!this.roadSyntaxRoadFeatures.length){this.roadSyntaxDisplaySuspended=!1;return}if(this.roadSyntaxUseArcgisWebgl&&typeof this.roadSyntaxCanUseArcgisWebglPayload=="function"&&this.roadSyntaxCanUseArcgisWebglPayload(this.roadSyntaxWebglPayload)){this.roadSyntaxDisplaySuspended=!1,this.renderRoadSyntaxByMetric(this.resolveRoadSyntaxActiveMetric());return}if(this.roadSyntaxStrictWebglOnly){this.roadSyntaxDisplaySuspended=!1,this.roadSyntaxSetStatus(this.buildRoadSyntaxWebglUnavailableMessage(this.roadSyntaxWebglPayload));return}this._roadSyntaxPinnedAttachKey="",this.roadSyntaxDisplaySuspended=!0,this.renderRoadSyntaxOverlays({type:"FeatureCollection",features:this.roadSyntaxRoadFeatures},{forceRebuild:!1,displayActive:!0})},clearRoadSyntaxLayerPool(){const t=this.roadSyntaxMap(),e=Array.isArray(this.roadSyntaxPolylines)?this.roadSyntaxPolylines:[];this.roadSyntaxSetLinesVisible(e,!1,t,{preferBatch:!0}),this.roadSyntaxClearViewportRefreshHandles(),this.roadSyntaxClearNodeRefreshTimer();const i=this.roadSyntaxLayerPool||{};Object.keys(i).forEach(a=>{this.roadSyntaxDisposeLayerEntry(i[a],t)}),this.roadSyntaxLayerPool={},this.roadSyntaxLayerStyleCache={},this.roadSyntaxLayerLodIndexCache={},this.roadSyntaxPolylines=[],this.roadSyntaxTargetVisibleLineSet={},this.roadSyntaxAppliedVisibleLineSet={},this.roadSyntaxResetVisibleIndexCache(),this.roadSyntaxResetLodScoreCache(),this.roadSyntaxResetSpatialIndex(),this.roadSyntaxBumpViewportRefreshToken(),this.roadSyntaxInteractionLowFidelity=!1,this.roadSyntaxCurrentStride=1,this.roadSyntaxActiveLayerKey="",this.roadSyntaxActiveLayerVariant="full",this.roadSyntaxPendingLayerKey="",this.roadSyntaxLayerBuildState={},this.roadSyntaxLayerBuildQueue=[],this.roadSyntaxLayerBuildRunning=!1,this.roadSyntaxPoolInitRunning=!1,this.roadSyntaxPoolReady=!1,this.roadSyntaxPoolDegraded=!1,this.roadSyntaxPoolInitTotal=0,this.roadSyntaxPoolInitDone=0,this.roadSyntaxLayerReadyMap={},this.roadSyntaxConnectivityReuseLayerKey=""},refreshRoadSyntaxLayerReadyMap(){const t=this.roadSyntaxLayerKeysForPrebuild(),e=this.roadSyntaxLayerBuildState||{},i=this.roadSyntaxLayerStyleCache||{},a={};return t.forEach(n=>{a[n]=!!i[n]&&e[n]==="ready"}),this.roadSyntaxLayerReadyMap=a,this.roadSyntaxPoolInitTotal=t.length,this.roadSyntaxPoolInitDone=Object.values(a).filter(n=>!!n).length,a},isRoadSyntaxMetricReady(t=null,e={}){if(!this.roadSyntaxSummary)return!1;const i=String(t||this.resolveRoadSyntaxActiveMetric()||this.roadSyntaxDefaultMetric());if(this.roadSyntaxStrictWebglOnly)return!!(this.roadSyntaxUseArcgisWebgl&&typeof this.roadSyntaxCanUseArcgisWebglPayload=="function"&&this.roadSyntaxCanUseArcgisWebglPayload(this.roadSyntaxWebglPayload));if(this.roadSyntaxUseArcgisWebgl&&typeof this.roadSyntaxCanUseArcgisWebglPayload=="function"&&this.roadSyntaxCanUseArcgisWebglPayload(this.roadSyntaxWebglPayload))return!0;const a=e&&Object.prototype.hasOwnProperty.call(e,"radiusLabel")?String(e.radiusLabel||"global"):this.roadSyntaxMetricUsesRadius(i)?String(this.roadSyntaxRadiusLabel||"global"):"global",n=e&&Object.prototype.hasOwnProperty.call(e,"skeletonOnly")?!!e.skeletonOnly:!1,s=this.resolveRoadSyntaxLayerKey(i,{radiusLabel:a,skeletonOnly:n});return this.isRoadSyntaxLayerReady(s)},canActivateRoadSyntaxTab(t){const e=String(t||"").trim();return e==="params"?!0:this.roadSyntaxSummary?this.isRoadSyntaxMetricReady(e):!1},canToggleRoadSyntaxSkeleton(){const t=this.resolveRoadSyntaxActiveMetric();return!this.roadSyntaxSupportsSkeleton(t)||!this.roadSyntaxSummary||this.roadSyntaxUseArcgisWebgl&&typeof this.roadSyntaxCanUseArcgisWebglPayload=="function"&&this.roadSyntaxCanUseArcgisWebglPayload(this.roadSyntaxWebglPayload)?!1:this.roadSyntaxSkeletonOnly?this.isRoadSyntaxMetricReady(t,{skeletonOnly:!1}):this.isRoadSyntaxMetricReady(t,{skeletonOnly:!0})},cancelRoadSyntaxNodeBuild(){this.roadSyntaxNodeBuildToken+=1,this.roadSyntaxNodeBuildRunning=!1},shouldRenderRoadSyntaxConnectivityNodes(){if(!this.mapCore||!this.mapCore.map)return!1;const t=Number(this.roadSyntaxConnectivityNodeMinZoom||15),e=Number(this.mapCore.map.getZoom?this.mapCore.map.getZoom():NaN);return Number.isFinite(e)?e>=t:!0},setRoadSyntaxNodeMarkersVisible(t){if(!Array.isArray(this.roadSyntaxNodeMarkers)||!this.roadSyntaxNodeMarkers.length)return;t&&!this.shouldRenderRoadSyntaxConnectivityNodes()&&(t=!1);const e=this.roadSyntaxNodeMarkers.slice(),i=t&&this.mapCore&&this.mapCore.map?this.mapCore.map:null;this.roadSyntaxEnqueueMapWrite(()=>(e.forEach(a=>this.safeMapSet(a,i)),{ok:!0,marker_count:e.length,visible:!!i}),{key:"road_syntax_node_visibility",replaceExisting:!0,meta:{reason:"road_syntax_node_visibility",marker_count:e.length,visible:!!i}})},clearRoadSyntaxNodeMarkers(t={}){if(this.cancelRoadSyntaxNodeBuild(),!Array.isArray(this.roadSyntaxNodeMarkers)){this.roadSyntaxNodeMarkers=[];return}const e=!!(t&&t.immediate),i=this.roadSyntaxNodeMarkers.slice();if(this.roadSyntaxNodeMarkers=[],!!i.length){if(e){i.forEach(a=>this.safeMapSet(a,null));return}this.roadSyntaxEnqueueMapWrite(()=>(i.forEach(a=>this.safeMapSet(a,null)),{ok:!0,marker_count:i.length}),{key:"road_syntax_node_clear",replaceExisting:!1,meta:{reason:"road_syntax_node_clear",marker_count:i.length}})}},disposeRoadSyntaxScatterChart(){this.clearRoadSyntaxScatterRenderTimer();const t=this.roadSyntaxScatterChart;t&&typeof t.dispose=="function"&&t.dispose(),this.roadSyntaxScatterChart=null},clearRoadSyntaxScatterRenderTimer(){this.roadSyntaxScatterRenderTimer&&(window.clearTimeout(this.roadSyntaxScatterRenderTimer),this.roadSyntaxScatterRenderTimer=null)},scheduleRoadSyntaxScatterRender(t=0){if(this.roadSyntaxMainTab!=="intelligibility")return;const e=Math.max(0,Number(t)||0),i=8;this.clearRoadSyntaxScatterRenderTimer();const a=e===0?0:Math.min(180,40+e*20);this.roadSyntaxScatterRenderTimer=window.setTimeout(()=>{this.roadSyntaxScatterRenderTimer=null,!this.renderRoadSyntaxScatterChart()&&e<i&&this.roadSyntaxMainTab==="intelligibility"&&this.scheduleRoadSyntaxScatterRender(e+1)},a)},setRoadSyntaxMainTab(t,e={}){const i=String(t||"").trim();if(!(this.roadSyntaxTabs||[]).map(y=>y.value).includes(i))return;if(i!=="params"&&this.roadSyntaxPoolInitRunning&&this.roadSyntaxUseLegacyPoolStatus()){this.roadSyntaxSetStatus(this.roadSyntaxFormatReadyStatus("图层预加载中",this.roadSyntaxPoolInitDone,this.roadSyntaxPoolInitTotal||0));return}const n=e.syncMetric!==!1,s=e.refresh!==!1,d=this.roadSyntaxMainTab,u=this.roadSyntaxMetric;if(this.roadSyntaxMainTab=i,i==="params"){this.cancelRoadSyntaxNodeBuild(),this.setRoadSyntaxNodeMarkersVisible(!1),this.disposeRoadSyntaxScatterChart(),this.mapCore&&typeof this.mapCore.setRadius=="function"&&this.mapCore.setRadius(0);return}if(!this.isRoadSyntaxMetricReady(i)){if(this.roadSyntaxStrictWebglOnly)this.roadSyntaxSetStatus(`指标“${this.roadSyntaxLabelByMetric(i)}”对应 ArcGIS-WebGL 数据未就绪`);else{const y=this.roadSyntaxLayerReadyCounts();this.roadSyntaxPoolDegraded?this.roadSyntaxSetStatus(`图层预处理已降级，指标“${this.roadSyntaxLabelByMetric(i)}”仍未就绪（${y.ready}/${y.total||0}）`):this.roadSyntaxSetStatus(`指标“${this.roadSyntaxLabelByMetric(i)}”仍在预处理（${y.ready}/${y.total||0}）`)}return}n&&(this.roadSyntaxMetric=i,this.roadSyntaxLastMetricTab=i),this.roadSyntaxMetricUsesRadius(i)?this.roadSyntaxHasRadiusLabel(this.roadSyntaxRadiusLabel)||(this.roadSyntaxRadiusLabel="global"):this.roadSyntaxRadiusLabel="global",this.roadSyntaxApplyRadiusCircle(i),!(d===i&&u===this.roadSyntaxMetric)&&s&&this.refreshRoadSyntaxOverlay()},roadSyntaxMetricTabs(){return(this.roadSyntaxTabs||[]).filter(t=>t.value!=="params")},roadSyntaxDefaultMetric(){const t=this.roadSyntaxMetricTabs();return t.length?String(t[0]&&t[0].value||"connectivity"):"connectivity"},roadSyntaxMetricDataCount(t=null){const e=String(t||this.resolveRoadSyntaxActiveMetric()||this.roadSyntaxDefaultMetric()),i=this.roadSyntaxSummary||{};return Number(e==="control"?i.control_valid_count||0:e==="depth"?i.depth_valid_count||0:i.edge_count||0)},isRoadSyntaxMetricAvailable(t=null){const e=String(t||this.resolveRoadSyntaxActiveMetric()||this.roadSyntaxDefaultMetric());return e!=="control"&&e!=="depth"?!0:this.roadSyntaxMetricDataCount(e)>0},roadSyntaxLabelByMetric(t){const e=String(t||"").trim(),i=this.roadSyntaxMetricTabs().find(a=>a.value===e);return i?i.label:e},roadSyntaxMetricUsesRadius(t=null){const e=t||this.roadSyntaxMetric||this.roadSyntaxDefaultMetric();return e==="choice"||e==="integration"},roadSyntaxSupportsSkeleton(t=null){return!1},onRoadSyntaxMetricChange(t){this.setRoadSyntaxMainTab(t)},formatRoadSyntaxMetricValue(t){const e=this.roadSyntaxSummary||{},i=t||this.roadSyntaxDefaultMetric();if(!this.isRoadSyntaxMetricAvailable(i))return"--";let a=NaN;if(i==="accessibility")a=Number(e.avg_accessibility_global??e.avg_closeness);else if(i==="connectivity")a=Number(e.avg_connectivity??e.avg_degree);else if(i==="control")a=Number(e.avg_control);else if(i==="depth")a=Number(e.avg_depth);else if(i==="choice"){const n=this.roadSyntaxNormalizeRadiusLabel(this.roadSyntaxRadiusLabel,i),s=e.avg_choice_by_radius&&typeof e.avg_choice_by_radius=="object"?e.avg_choice_by_radius:{};a=Number(n==="global"?e.avg_choice_global:s[n]),Number.isFinite(a)||(a=Number(e.avg_choice_global))}else if(i==="integration"){const n=this.roadSyntaxNormalizeRadiusLabel(this.roadSyntaxRadiusLabel,i),s=e.avg_integration_by_radius&&typeof e.avg_integration_by_radius=="object"?e.avg_integration_by_radius:{};a=Number(n==="global"?e.avg_integration_global:s[n]),Number.isFinite(a)||(a=Number(e.avg_integration_global))}else i==="intelligibility"&&(a=Number(e.avg_intelligibility));return Number.isFinite(a)?i==="connectivity"?a.toFixed(2):i==="intelligibility"?a.toFixed(4):a.toFixed(6):"--"},roadSyntaxRadiusOptions(){const e=(this.roadSyntaxSummary&&Array.isArray(this.roadSyntaxSummary.radius_labels)?this.roadSyntaxSummary.radius_labels:[]).map(a=>String(a||"").trim().toLowerCase()),i=[{value:"global",label:"等时圈内"}];return e.includes("r600")&&i.push({value:"r600",label:"600m"}),e.includes("r800")&&i.push({value:"r800",label:"800m"}),i},roadSyntaxHasRadiusLabel(t){const e=String(t||"").trim().toLowerCase();return e?this.roadSyntaxRadiusOptions().some(i=>String(i.value)===e):!1},roadSyntaxNormalizeRadiusLabel(t,e=null){const i=e||this.resolveRoadSyntaxActiveMetric(),a=String(t||"global").trim().toLowerCase();return this.roadSyntaxMetricUsesRadius(i)&&this.roadSyntaxHasRadiusLabel(a)?a:"global"},roadSyntaxRadiusMeters(t=null,e=null){const i=this.roadSyntaxNormalizeRadiusLabel(t??this.roadSyntaxRadiusLabel,e);return i==="r600"?600:i==="r800"?800:0},roadSyntaxApplyRadiusCircle(t=null){const e=t||this.resolveRoadSyntaxActiveMetric();let i=0;this.roadSyntaxMetricUsesRadius(e)&&(i=this.roadSyntaxRadiusMeters(this.roadSyntaxRadiusLabel,e));const a=!!(this.selectedPoint&&Number.isFinite(Number(this.selectedPoint.lng))&&Number.isFinite(Number(this.selectedPoint.lat)));this.mapCore&&typeof this.mapCore.setRadius=="function"&&this.mapCore.setRadius(i>0&&a?i:0)},setRoadSyntaxRadiusLabel(t){const e=this.resolveRoadSyntaxActiveMetric();if(!this.roadSyntaxMetricUsesRadius(e))return;const i=this.roadSyntaxNormalizeRadiusLabel(t,e);if(this.roadSyntaxHasRadiusLabel(i)){if(i===String(this.roadSyntaxRadiusLabel||"global")){this.roadSyntaxApplyRadiusCircle(e);return}this.roadSyntaxRadiusLabel=i,this.roadSyntaxApplyRadiusCircle(e),this.refreshRoadSyntaxOverlay()}},normalizeRoadSyntaxGraphModel(t=null){return String(t??this.roadSyntaxGraphModel).trim().toLowerCase()==="axial"?"axial":"segment"},roadSyntaxGraphModelLabel(t=null){return this.normalizeRoadSyntaxGraphModel(t)==="axial"?"轴线图":"线段图"},async fetchRoadSyntaxApi(t,e={}){const i=e&&e.signal?e.signal:void 0,a=await fetch("/api/v1/analysis/road-syntax",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t),signal:i});if(!a.ok){let n="";try{const s=await a.json();s&&typeof s=="object"&&(typeof s.detail=="string"&&s.detail.trim()?n=s.detail.trim():n=JSON.stringify(s))}catch{try{n=await a.text()}catch{}}throw new Error(n||"路网分析失败")}return await a.json()},async applyRoadSyntaxDataset(t,e="connectivity"){if(this.invalidateRoadSyntaxCache("switch-road-syntax-scope",{resetData:!1,resetPerf:!1}),this.applyRoadSyntaxResponseData(t,e),!this.roadSyntaxSummary)return;const i=this.roadSyntaxLastMetricTab||this.roadSyntaxMetric||this.roadSyntaxDefaultMetric();this.setRoadSyntaxMainTab(i,{refresh:!1,syncMetric:!0}),this.activeStep3Panel==="syntax"&&await this.renderRoadSyntaxByMetric(i)},resolveRoadSyntaxRequestMetric(){return this.roadSyntaxMetric==="choice"?"choice":"integration"},clamp01(t){return Math.max(0,Math.min(1,Number(t)||0))},blendTwoColor(t,e,i){const a=Array.isArray(t)?t:[0,0,0],n=Array.isArray(e)?e:[0,0,0],s=this.clamp01(i),d=Math.round(a[0]+(n[0]-a[0])*s),u=Math.round(a[1]+(n[1]-a[1])*s),y=Math.round(a[2]+(n[2]-a[2])*s),g=S=>{const m=Math.max(0,Math.min(255,S)).toString(16);return m.length===1?"0"+m:m};return`#${g(d)}${g(u)}${g(y)}`},blendPaletteColor(t,e){const i=Array.isArray(t)&&t.length?t:[[0,0,0],[255,255,255]],a=this.clamp01(e),n=g=>{const S=Math.max(0,Math.min(255,g)).toString(16);return S.length===1?"0"+S:S};if(i.length===1){const g=i[0];return`#${n(g[0])}${n(g[1])}${n(g[2])}`}const s=Math.min(i.length-2,Math.floor(a*(i.length-1))),d=s/(i.length-1),u=(s+1)/(i.length-1),y=(a-d)/Math.max(1e-9,u-d);return this.blendTwoColor(i[s],i[s+1],y)},onRoadSyntaxDisplayRangeChange(){const t=this.clamp01(Number(this.roadSyntaxDisplayBlue)),e=this.clamp01(Number(this.roadSyntaxDisplayRed));this.roadSyntaxDisplayBlue=Number.isFinite(t)?t:0,this.roadSyntaxDisplayRed=Number.isFinite(e)?e:1,this.roadSyntaxMainTab!=="params"&&this.refreshRoadSyntaxOverlay()},roadSyntaxDepthmapColorSchemes(){return{axmanesque:["#3333dd","#3388dd","#22ccdd","#22ccbb","#22dd88","#88dd22","#bbcc22","#ddcc22","#dd8833","#dd3333"],hueonlyaxmanesque:["#3333dd","#3377dd","#33bbdd","#33ddbb","#33dd55","#55dd33","#bbdd33","#ddbb33","#dd7733","#dd3333"],bluered:["#4575b4","#91bfdb","#e0f3f8","#ffffbf","#fee090","#fc8d59","#d73027"],purpleorange:["#542788","#998ec3","#d8daeb","#f7f7f7","#fee0b6","#f1a340","#b35806"],greyscale:["#000000","#444444","#777777","#aaaaaa","#cccccc","#eeeeee","#ffffff"],monochrome:["#000000","#444444","#777777","#aaaaaa","#cccccc","#eeeeee","#ffffff"]}},roadSyntaxDepthmapColorScaleOptions(){return[{value:"axmanesque",label:"Equal Ranges (3-Colour)"},{value:"bluered",label:"Equal Ranges (Blue-Red)"},{value:"purpleorange",label:"Equal Ranges (Purple-Orange)"},{value:"depthmapclassic",label:"depthmapX Classic"},{value:"greyscale",label:"Equal Ranges (Greyscale)"},{value:"monochrome",label:"Equal Ranges (Monochrome)"},{value:"hueonlyaxmanesque",label:"Equal Ranges (3-Colour Hue Only)"}]},roadSyntaxDepthmapColorScaleLabel(){const t=String(this.roadSyntaxDepthmapColorScale||"axmanesque"),i=this.roadSyntaxDepthmapColorScaleOptions().find(a=>String(a.value)===t);return i?i.label:"Equal Ranges (3-Colour)"},roadSyntaxDepthmapDisplayParams(){const t=this.clamp01(Number(this.roadSyntaxDisplayBlue)),e=this.clamp01(Number(this.roadSyntaxDisplayRed));let i=t,a=e,n=!1;return i>a&&(n=!0,i=1-t,a=1-e),{rawBlue:t,rawRed:e,blue:this.clamp01(i),red:this.clamp01(a),inverted:n}},roadSyntaxDepthmapPalette(){const t=this.roadSyntaxDepthmapColorSchemes(),e=String(this.roadSyntaxDepthmapColorScale||"axmanesque").toLowerCase();return Array.isArray(t[e])&&t[e].length?t[e]:t.axmanesque},roadSyntaxDepthmapClassIndex(t,e){const i=Math.max(1,Number(e)||1),a=this.clamp01(t),n=Math.floor((a-1e-9)*i);return Math.max(0,Math.min(i-1,n))},roadSyntaxDepthmapScaledField(t){if(!Number.isFinite(Number(t)))return NaN;const e=String(this.roadSyntaxDepthmapColorScale||"axmanesque").toLowerCase(),i=this.roadSyntaxDepthmapDisplayParams();let a=this.clamp01(Number(t));if(i.inverted&&(a=1-a),e==="depthmapclassic")return a;const n=i.red-i.blue;if(!(n>1e-9))return .5;const s=(a-i.blue)/n;return Number.isFinite(s)?this.clamp01(s):.5},roadSyntaxNormalizeScoreByRange(t,e,i){const a=Number(t),n=Number(e),s=Number(i);return Number.isFinite(a)?!Number.isFinite(n)||!Number.isFinite(s)||s<=n?this.clamp01(a):this.clamp01((a-n)/Math.max(1e-9,s-n)):0},roadSyntaxDepthmapClassicByte(t){const e=this.clamp01(t),i=Math.floor((e+.0333)*15);return Math.max(0,Math.min(255,i*17))},roadSyntaxDepthmapClassicColor(t,e=null,i=null){const a=this.clamp01(t),n=this.roadSyntaxDepthmapDisplayParams(),s=Number.isFinite(Number(e))?this.clamp01(Number(e)):n.blue,d=Number.isFinite(Number(i))?this.clamp01(Number(i)):n.red,u=s+(d-s)/10;let y=0,g=0,S=0;a>=0&&a<s?(y=this.roadSyntaxDepthmapClassicByte(.5*(s-a)/Math.max(1e-9,s)),S=255):a>=s&&a<(u+s)/2?(S=255,g=this.roadSyntaxDepthmapClassicByte(2*(a-s)/Math.max(1e-9,u-s))):a>=(u+s)/2&&a<u?(S=this.roadSyntaxDepthmapClassicByte(2*(u-a)/Math.max(1e-9,u-s)),g=255):a>=u&&a<(u+d)/2?(g=255,y=this.roadSyntaxDepthmapClassicByte(2*(a-u)/Math.max(1e-9,d-u))):a>=(u+d)/2&&a<d?(g=this.roadSyntaxDepthmapClassicByte(2*(d-a)/Math.max(1e-9,d-u)),y=255):(y=255,S=this.roadSyntaxDepthmapClassicByte(.5*(a-d)/Math.max(1e-9,1-d)));const m=x=>{const M=Math.max(0,Math.min(255,Number(x)||0)).toString(16);return M.length===1?`0${M}`:M};return`#${m(y)}${m(g)}${m(S)}`},roadSyntaxDepthmapClassColor(t,e=null){const i=Array.isArray(e)&&e.length?e:this.roadSyntaxDepthmapPalette(),a=String(this.roadSyntaxDepthmapColorScale||"axmanesque").toLowerCase();if(!Number.isFinite(Number(t)))return a==="monochrome"||a==="greyscale"?"rgba(0,0,0,0)":"#7f7f7f";const n=this.roadSyntaxDepthmapScaledField(t);if(a==="depthmapclassic"){const d=this.roadSyntaxDepthmapDisplayParams();return this.roadSyntaxDepthmapClassicColor(n,d.blue,d.red)}const s=this.roadSyntaxDepthmapClassIndex(n,i.length);return String(i[s]||"#3333dd")},roadSyntaxEqualRangeLegendItems(t,e=null){const i=String(this.roadSyntaxDepthmapColorScale||"axmanesque").toLowerCase(),a=Array.isArray(e)&&e.length?e:this.roadSyntaxDepthmapPalette(),n=i==="depthmapclassic"?new Array(10).fill(0).map((m,x)=>this.roadSyntaxDepthmapClassColor((x+.5)/10,a)):a,s=(Array.isArray(t)?t:[]).map(m=>Number(m)).filter(m=>Number.isFinite(m)).sort((m,x)=>m-x);if(!s.length)return n.map((m,x)=>({color:m,label:`等级 ${x+1}`}));const d=s[0],u=s[s.length-1];if(!(u>d))return n.map((m,x)=>({color:m,label:x===0?`${d.toFixed(2)}`:"-"}));const y=u-d,g=n,S=this.roadSyntaxDepthmapDisplayParams();return g.map((m,x)=>{let M=x/g.length,k=(x+1)/g.length;i!=="depthmapclassic"&&(M=S.blue+(S.red-S.blue)*M,k=S.blue+(S.red-S.blue)*k);const R=d+y*this.clamp01(M),f=d+y*this.clamp01(k);return{color:m,label:`${R.toFixed(2)} - ${f.toFixed(2)}`}})},roadSyntaxSummarizeCoordInput(t){if(t===null)return{type:"null"};if(typeof t>"u")return{type:"undefined"};if(typeof t=="string")return{type:"string",value:String(t).slice(0,80)};if(Array.isArray(t))return{type:"array",length:t.length,head:t.slice(0,2)};if(typeof t=="object"){const e={type:"object"};return Object.prototype.hasOwnProperty.call(t,"lng")&&(e.lng=t.lng),Object.prototype.hasOwnProperty.call(t,"lat")&&(e.lat=t.lat),Object.prototype.hasOwnProperty.call(t,"lon")&&(e.lon=t.lon),typeof t.getLng=="function"&&(e.getLng=!0),typeof t.getLat=="function"&&(e.getLat=!0),e}return{type:typeof t,value:t}},roadSyntaxLogInvalidCoordInput(t="",e=null){const i=String(t||"unknown");this._roadSyntaxInvalidCoordStats||(this._roadSyntaxInvalidCoordStats=Object.create(null));const a=this._roadSyntaxInvalidCoordStats;a[i]||(a[i]={count:0}),a[i].count+=1;const n=a[i].count;n<=5?console.warn("[road-syntax] invalid coordinate input",{source:i,count:n,sample:this.roadSyntaxSummarizeCoordInput(e)}):n%100===0&&console.warn("[road-syntax] invalid coordinate input aggregated",{source:i,count:n})},normalizeLngLat(t,e=""){let i=NaN,a=NaN;if(Array.isArray(t)&&t.length>=2)i=Number(t[0]),a=Number(t[1]);else if(t&&typeof t=="object")typeof t.getLng=="function"&&typeof t.getLat=="function"?(i=Number(t.getLng()),a=Number(t.getLat())):Object.prototype.hasOwnProperty.call(t,"lng")&&Object.prototype.hasOwnProperty.call(t,"lat")?(i=Number(t.lng),a=Number(t.lat)):Object.prototype.hasOwnProperty.call(t,"lon")&&Object.prototype.hasOwnProperty.call(t,"lat")&&(i=Number(t.lon),a=Number(t.lat));else if(typeof t=="string"){const n=t.split(",");n.length>=2&&(i=Number(n[0].trim()),a=Number(n[1].trim()))}return!Number.isFinite(i)||!Number.isFinite(a)?(this.roadSyntaxLogInvalidCoordInput(e||"normalize_lnglat",t),null):i<-180||i>180||a<-90||a>90?(this.roadSyntaxLogInvalidCoordInput(e||"normalize_lnglat_range",{input:this.roadSyntaxSummarizeCoordInput(t),lng:i,lat:a}),null):[i,a]},normalizePath(t,e=2,i=""){const a=Array.isArray(t)?t:[],n=[];return a.forEach(s=>{const d=this.normalizeLngLat(s,i||"normalize_path");d&&n.push(d)}),n.length>=e?n:[]},resolveRoadSyntaxActiveMetric(){const t=this.roadSyntaxDefaultMetric(),e=this.roadSyntaxMetricTabs().map(s=>String(s.value||"")),i=this.roadSyntaxMainTab==="params"?this.roadSyntaxLastMetricTab||this.roadSyntaxMetric:this.roadSyntaxMetric,a=String(i||"").trim();if(e.includes(a))return a;const n=String(this.roadSyntaxMetric||"").trim();return e.includes(n)?n:t},resolveRoadSyntaxMetricField(t=null,e=null){const i=t||this.resolveRoadSyntaxActiveMetric(),a=this.roadSyntaxNormalizeRadiusLabel(e??this.roadSyntaxRadiusLabel,i);return i==="connectivity"?"connectivity_score":i==="control"?"control_score":i==="depth"?"depth_score":i==="intelligibility"?"intelligibility_score":i==="choice"?a==="global"?"choice_global":`choice_${a}`:i==="integration"?a==="global"?"integration_global":`integration_${a}`:"connectivity_score"},resolveRoadSyntaxLayerKey(t=null,e={}){const i=t||this.resolveRoadSyntaxActiveMetric(),a=e&&Object.prototype.hasOwnProperty.call(e,"skeletonOnly")?!!e.skeletonOnly:!!this.roadSyntaxSkeletonOnly,n=e&&Object.prototype.hasOwnProperty.call(e,"radiusLabel")?String(e.radiusLabel||"global"):this.roadSyntaxMetricUsesRadius(i)?String(this.roadSyntaxRadiusLabel||"global"):"global",s=this.roadSyntaxNormalizeRadiusLabel(n,i),u=(typeof this.roadSyntaxSupportsSkeleton=="function"?!!this.roadSyntaxSupportsSkeleton(i):i==="choice"||i==="integration")?a:!1,y=this.roadSyntaxMetricUsesRadius(i)?s:"global";return`${i}|${y}|${u?1:0}`},parseRoadSyntaxLayerKey(t){const e=String(t||"").split("|"),i=e[0]||this.roadSyntaxDefaultMetric(),a=e[1]||"global",n=e[2]==="1";return{metric:i,radiusLabel:a,skeletonOnly:n}},roadSyntaxLayerKeysForPrebuild(){const t=this.roadSyntaxRadiusOptions().map(a=>String(a.value||"global")),e=t.map(a=>this.resolveRoadSyntaxLayerKey("choice",{radiusLabel:a,skeletonOnly:!1})),i=t.map(a=>this.resolveRoadSyntaxLayerKey("integration",{radiusLabel:a,skeletonOnly:!1}));return[this.resolveRoadSyntaxLayerKey("connectivity",{radiusLabel:"global",skeletonOnly:!1}),this.resolveRoadSyntaxLayerKey("control",{radiusLabel:"global",skeletonOnly:!1}),this.resolveRoadSyntaxLayerKey("depth",{radiusLabel:"global",skeletonOnly:!1}),...e,...i,this.resolveRoadSyntaxLayerKey("intelligibility",{radiusLabel:"global",skeletonOnly:!1})]},resolveRoadSyntaxRankField(t){return t==="choice"?"rank_quantile_choice":t==="integration"?"rank_quantile_integration":t==="accessibility"?"rank_quantile_accessibility":""},roadSyntaxScoreFromProps(t,e,i){const a=d=>{if(!t||typeof t!="object")return NaN;if(!Object.prototype.hasOwnProperty.call(t,d))return NaN;const u=t[d];if(u===null||typeof u>"u"||u==="")return NaN;const y=Number(u);return Number.isFinite(y)?y:NaN},n=a(e),s=a(i);return Number.isFinite(n)?this.clamp01(n):Number.isFinite(s)?this.clamp01(s):NaN},roadSyntaxQuantileBreakLabels(t){const e=(Array.isArray(t)?t:[]).map(a=>Number(a)).filter(a=>Number.isFinite(a)).sort((a,n)=>a-n);if(!e.length)return["P10 --","P30 --","P70 --","P90 --"];const i=a=>{const n=Math.max(0,Math.min(1,a));if(e.length===1)return e[0];const s=n*(e.length-1),d=Math.floor(s),u=Math.min(e.length-1,d+1),y=s-d;return e[d]+(e[u]-e[d])*y};return[`P10 ${i(.1).toFixed(2)}`,`P30 ${i(.3).toFixed(2)}`,`P70 ${i(.7).toFixed(2)}`,`P90 ${i(.9).toFixed(2)}`]},buildRoadSyntaxLegendModel(t){const e=t||this.resolveRoadSyntaxActiveMetric(),i=this.resolveRoadSyntaxMetricField(e),a=this.resolveRoadSyntaxFallbackField(e),n=this.roadSyntaxDepthmapPalette(),s=this.roadSyntaxDepthmapColorScaleLabel();let u=(Array.isArray(this.roadSyntaxPolylineItems)?this.roadSyntaxPolylineItems:[]).map(y=>this.roadSyntaxScoreFromProps(y&&y.props||{},i,a));return u.length||(u=(Array.isArray(this.roadSyntaxRoadFeatures)?this.roadSyntaxRoadFeatures:[]).map(g=>this.roadSyntaxScoreFromProps(g&&g.properties||{},i,a))),e==="accessibility"?{type:"discrete",title:`可达性（${s}）`,items:this.roadSyntaxEqualRangeLegendItems(u,n)}:e==="integration"?{type:"discrete",title:`整合度（${s}）`,items:this.roadSyntaxEqualRangeLegendItems(u,n)}:e==="choice"?{type:"discrete",title:`选择度（${s}）`,items:this.roadSyntaxEqualRangeLegendItems(u,n)}:e==="connectivity"?{type:"discrete",title:`连接度（${s}）`,items:this.roadSyntaxEqualRangeLegendItems(u,n)}:e==="control"?{type:"discrete",title:`控制值（${s}）`,items:this.roadSyntaxEqualRangeLegendItems(u,n)}:e==="depth"?{type:"discrete",title:`深度值（${s}）`,items:this.roadSyntaxEqualRangeLegendItems(u,n)}:{type:"discrete",title:"可理解度（散点回归）",items:[{label:"样本点",color:"#2563eb"},{label:"回归线",color:"#dc2626"}]}},roadSyntaxFootnoteByMetric(t=null){const e=t||this.resolveRoadSyntaxActiveMetric(),i=this.roadSyntaxDepthmapColorScaleLabel(),a=this.roadSyntaxDepthmapDisplayParams(),n=`(Blue=${a.rawBlue.toFixed(2)}, Red=${a.rawRed.toFixed(2)})`;if(e==="connectivity")return`连接度采用 depthmapX ${i} ${n} 的线段着色图表达，不启用节点点层。`;if(e==="control"){const s=String(this.roadSyntaxSummary&&this.roadSyntaxSummary.control_source_column||"");return this.isRoadSyntaxMetricAvailable("control")?s==="topology_fallback"?"控制值当前采用拓扑回退计算（depthmap 控制列不可用或近常量），用于保障稳定显示。":`控制值采用 depthmapX ${i} ${n} 的线段着色表达。`:`控制值当前无有效样本${s?`（列：${s}）`:""}，请检查 depthmap 输出列与分析参数。`}if(e==="depth"){if(!this.isRoadSyntaxMetricAvailable("depth")){const s=String(this.roadSyntaxSummary&&this.roadSyntaxSummary.depth_source_column||"");return`深度值当前无有效样本${s?`（列：${s}）`:""}，请检查 depthmap 输出列与分析参数。`}return`深度值采用 depthmapX ${i} ${n} 的线段着色表达。`}return e==="choice"?`选择度采用 depthmapX ${i} ${n} 的线段着色表达。`:e==="integration"?`整合度采用 depthmapX ${i} ${n} 的线段着色表达网络中心性。`:e==="intelligibility"?"可理解度主表达为散点回归图（x=连接度，y=整合度）；地图蓝线为网络参考层。":`连接度采用 depthmapX ${i} ${n} 的线段着色表达。`},roadSyntaxRegressionView(){const t=this.roadSyntaxDiagnostics||{},e=t.regression||{},i=this.roadSyntaxSummary||{},a=Number(e.r),n=Number(e.r2),s=Number(e.n),d=Number(i.avg_intelligibility),u=Number(i.avg_intelligibility_r2);return{r:Number.isFinite(a)?a.toFixed(4):Number.isFinite(d)?d.toFixed(4):"--",r2:Number.isFinite(n)?n.toFixed(4):Number.isFinite(u)?u.toFixed(4):"--",n:Number.isFinite(s)?String(Math.round(s)):String((t.intelligibility_scatter||[]).length||0),slope:Number.isFinite(Number(e.slope))?Number(e.slope):0,intercept:Number.isFinite(Number(e.intercept))?Number(e.intercept):0}},buildRoadSyntaxStyleForMetric(t,e,i,a,n=null){const s=this.roadSyntaxScoreFromProps(t,e,i),d=a||this.resolveRoadSyntaxActiveMetric(),y=(typeof this.roadSyntaxSupportsSkeleton=="function"?!!this.roadSyntaxSupportsSkeleton(d):d==="choice"||d==="integration")&&(n===null?!!this.roadSyntaxSkeletonOnly:!!n),g=this.roadSyntaxDepthmapPalette(),S=String(this.roadSyntaxDepthmapColorScale||"axmanesque").toLowerCase(),m=this.roadSyntaxDepthmapClassColor(s,g),x=2.1,R=!Number.isFinite(Number(s))&&(S==="monochrome"||S==="greyscale")?0:.88;if(d==="accessibility")return{strokeColor:m,strokeWeight:x,strokeOpacity:R,zIndex:90};if(d==="integration"){const f=!!(t&&t.is_skeleton_integration_top20);return y&&!f?{strokeColor:"#a1a1aa",strokeWeight:1.5,strokeOpacity:.15,zIndex:82}:{strokeColor:m,strokeWeight:x,strokeOpacity:R,zIndex:91}}if(d==="choice"){const f=!!(t&&t.is_skeleton_choice_top20);return y&&!f?{strokeColor:"#9ca3af",strokeWeight:1.5,strokeOpacity:.15,zIndex:82}:{strokeColor:m,strokeWeight:x,strokeOpacity:R,zIndex:92}}return d==="connectivity"?{strokeColor:m,strokeWeight:x,strokeOpacity:R,zIndex:80}:d==="control"?{strokeColor:m,strokeWeight:x,strokeOpacity:R,zIndex:81}:d==="depth"?{strokeColor:m,strokeWeight:x,strokeOpacity:R,zIndex:81}:d==="intelligibility"?{strokeColor:"#2563eb",strokeWeight:2.2,strokeOpacity:.62,zIndex:79}:{strokeColor:"#9ca3af",strokeWeight:1.4,strokeOpacity:.22,zIndex:79}},refreshRoadSyntaxOverlay(){if(this.roadSyntaxMainTab==="params")return;const t=this.resolveRoadSyntaxActiveMetric();if(t==="intelligibility"){const n=this.parseRoadSyntaxLayerKey(this.roadSyntaxActiveLayerKey||""),s=String(n&&n.metric||"");if((typeof this.roadSyntaxIsArcgisWebglActive=="function"?this.roadSyntaxIsArcgisWebglActive():!!this.roadSyntaxWebglActive)&&s==="intelligibility"){this.roadSyntaxLegendModel=this.buildRoadSyntaxLegendModel(t),this.$nextTick(()=>this.scheduleRoadSyntaxScatterRender(0));return}}const e=this.roadSyntaxSupportsSkeleton(t),i=e?!!this.roadSyntaxSkeletonOnly:!1;if(!e&&this.roadSyntaxSkeletonOnly&&(this.roadSyntaxSkeletonOnly=!1),!this.isRoadSyntaxMetricReady(t,{skeletonOnly:i})){if(this.roadSyntaxStrictWebglOnly)this.roadSyntaxSetStatus(this.buildRoadSyntaxWebglUnavailableMessage(this.roadSyntaxWebglPayload));else{const n=this.roadSyntaxLayerReadyCounts();this.roadSyntaxSetStatus(`目标图层仍在预处理（${n.ready}/${n.total||0}）`)}return}this.renderRoadSyntaxByMetric(this.resolveRoadSyntaxActiveMetric())},async renderRoadSyntaxByMetric(t=null){const e=t||this.resolveRoadSyntaxActiveMetric();this.roadSyntaxApplyRadiusCircle(e);const i=this.roadSyntaxUseArcgisWebgl&&typeof this.roadSyntaxCanUseArcgisWebglPayload=="function"&&this.roadSyntaxCanUseArcgisWebglPayload(this.roadSyntaxWebglPayload);if(i&&typeof this.renderRoadSyntaxArcgisWebgl=="function"){let a=!1;try{a=await this.renderRoadSyntaxArcgisWebgl(this.roadSyntaxWebglPayload,{hideWhenSuspended:!0})}catch(n){a=!1,console.warn("[road-syntax] arcgis webgl render failed",n)}if(a){this.cancelRoadSyntaxNodeBuild(),this.setRoadSyntaxNodeMarkersVisible(!1),e==="intelligibility"?this.$nextTick(()=>this.scheduleRoadSyntaxScatterRender(0)):this.disposeRoadSyntaxScatterChart(),this.roadSyntaxLegendModel=this.buildRoadSyntaxLegendModel(e);return}}if(this.clearRoadSyntaxOverlays(),this.roadSyntaxLegendModel=null,this.cancelRoadSyntaxNodeBuild(),this.setRoadSyntaxNodeMarkersVisible(!1),this.disposeRoadSyntaxScatterChart(),i){const a=String(this.roadSyntaxWebglStatus||"").trim();this.roadSyntaxSetStatus(a?`ArcGIS-WebGL 渲染失败（已禁用旧版回退）: ${a}`:"ArcGIS-WebGL 渲染失败（已禁用旧版回退）")}else this.roadSyntaxSetStatus(this.buildRoadSyntaxWebglUnavailableMessage(this.roadSyntaxWebglPayload))},resolveRoadSyntaxFallbackField(t){let e="connectivity_score";return t==="choice"?e="choice_score":t==="integration"?e="integration_score":t==="connectivity"?e="degree_score":t==="control"?e="control_score":t==="depth"?e="depth_score":t==="intelligibility"&&(e="intelligibility_score"),e},renderRoadSyntaxNodeMarkers(t={}){if(!this.mapCore||!this.mapCore.map||!window.AMap)return;const e=!!(t&&t.forceRebuild);if(!this.shouldRenderRoadSyntaxConnectivityNodes()){this.cancelRoadSyntaxNodeBuild(),this.setRoadSyntaxNodeMarkersVisible(!1);return}let i=Array.isArray(this.roadSyntaxNodes)?this.roadSyntaxNodes:[];if(!i.length){const x={};(this.roadSyntaxPolylineItems||[]).forEach(M=>{const k=Array.isArray(M&&M.coords)?M.coords:[],R=M&&M.props||{},f=this.clamp01(Number(R.degree_score));[k[0],k[k.length-1]].forEach(L=>{const P=this.normalizeLngLat(L,"road_syntax.node_fallback.endpoint");if(!P)return;const C=`${P[0].toFixed(6)},${P[1].toFixed(6)}`,I=x[C];(!I||f>I.score)&&(x[C]={loc:P,score:f})})}),i=Object.keys(x).map(M=>({geometry:{coordinates:x[M].loc},properties:{degree_score:x[M].score,degree:Math.round(x[M].score*10),integration_global:0}}))}if(!i.length){this.clearRoadSyntaxNodeMarkers({immediate:!0});return}const a=Number(this.mapCore.map.getZoom?this.mapCore.map.getZoom():NaN);let n=i;if(Number.isFinite(a)&&a<16&&i.length>2200){const x=Math.max(1,Math.ceil(i.length/1800));n=i.filter((M,k)=>k%x===0)}const s=this.normalizeLngLat(((n[0]||{}).geometry||{}).coordinates||[],"road_syntax.node_fingerprint.first")||[0,0],d=this.normalizeLngLat(((n[n.length-1]||{}).geometry||{}).coordinates||[],"road_syntax.node_fingerprint.last")||[0,0],u=`${n.length}|${s[0].toFixed(6)},${s[1].toFixed(6)}|${d[0].toFixed(6)},${d[1].toFixed(6)}`;if(!e&&u===this.roadSyntaxNodeSourceFingerprint&&Array.isArray(this.roadSyntaxNodeMarkers)&&this.roadSyntaxNodeMarkers.length){this.setRoadSyntaxNodeMarkersVisible(!0);return}this.clearRoadSyntaxNodeMarkers({immediate:!0});const y=this.roadSyntaxNodeBuildToken+1;this.roadSyntaxNodeBuildToken=y,this.roadSyntaxNodeBuildRunning=!0;const g=[];let S=0;const m=()=>{if(y!==this.roadSyntaxNodeBuildToken){this.roadSyntaxEnqueueMapWrite(()=>(g.forEach(f=>this.safeMapSet(f,null)),{ok:!0,marker_count:g.length}),{key:`road_syntax_node_build_abort:${y}`,replaceExisting:!1,meta:{reason:"road_syntax_node_build_abort",marker_count:g.length}});return}if(!this.shouldRenderRoadSyntaxConnectivityNodes()){this.roadSyntaxEnqueueMapWrite(()=>(g.forEach(f=>this.safeMapSet(f,null)),{ok:!0,marker_count:g.length}),{key:`road_syntax_node_build_hidden:${y}`,replaceExisting:!1,meta:{reason:"road_syntax_node_build_hidden",marker_count:g.length}}),this.roadSyntaxNodeBuildRunning=!1;return}const x=window.performance&&typeof window.performance.now=="function"?()=>window.performance.now():()=>Date.now(),M=x(),k=this.roadSyntaxResolveFrameBudget("node"),R=[];for(;S<n.length;){const f=n[S]||{};S+=1;const A=this.normalizeLngLat(((f||{}).geometry||{}).coordinates||[],"road_syntax.node_marker.center");if(!A)continue;const L=f&&f.properties||{},P=this.clamp01(Number(L.degree_score)),C=new AMap.CircleMarker({center:A,radius:3+P*7,strokeColor:"#ffffff",strokeWeight:1,fillColor:this.blendTwoColor([203,213,225],[153,27,27],P),fillOpacity:.88,zIndex:115,bubble:!0,clickable:!1,cursor:"default"});if(g.push(C),R.push(C),x()-M>=k)break}if(R.length){const f=R.length,A=S;this.roadSyntaxEnqueueMapWrite(()=>{if(y!==this.roadSyntaxNodeBuildToken)return R.forEach(P=>this.safeMapSet(P,null)),{ok:!1,skipped:!0,reason:"stale_node_build_chunk"};const L=this.mapCore&&this.mapCore.map&&this.shouldRenderRoadSyntaxConnectivityNodes()?this.mapCore.map:null;return R.forEach(P=>this.safeMapSet(P,L)),{ok:!0,marker_count:f,visible:!!L}},{key:`road_syntax_node_build_chunk:${y}:${A}`,replaceExisting:!1,meta:{reason:"road_syntax_node_build_chunk",marker_count:f}})}if(this.roadSyntaxNodeMarkers=g,S<n.length){window.requestAnimationFrame(m);return}this.roadSyntaxNodeBuildRunning=!1,this.roadSyntaxNodeSourceFingerprint=u,this.setRoadSyntaxNodeMarkersVisible(!0)};window.requestAnimationFrame(m)},renderRoadSyntaxScatterChart(){if(this.roadSyntaxMainTab!=="intelligibility")return this.disposeRoadSyntaxScatterChart(),!1;if(!window.echarts)return this.roadSyntaxSetStatus("可理解度图表库未加载（echarts）"),!1;const t=document.getElementById("roadSyntaxScatterChart");if(!t||t.clientWidth===0||t.clientHeight===0)return!1;const e=this.roadSyntaxDiagnostics||{};let i=this.normalizeRoadSyntaxScatterPoints(e.intelligibility_scatter);if(!i.length&&Array.isArray(this.roadSyntaxScatterPointsCache)&&this.roadSyntaxScatterPointsCache.length&&(i=this.normalizeRoadSyntaxScatterPoints(this.roadSyntaxScatterPointsCache)),i.length||(i=this.buildRoadSyntaxScatterFallbackPoints()),i.length&&(this.roadSyntaxScatterPointsCache=i.slice()),!i.length){this.roadSyntaxSetStatus("可理解度样本为空（暂无可回归数据）");let y=this.roadSyntaxScatterChart;return(!y||y.isDisposed())&&(y=echarts.getInstanceByDom(t)||echarts.init(t),this.roadSyntaxScatterChart=y),y.setOption({animation:!1,xAxis:{show:!1,min:0,max:1},yAxis:{show:!1,min:0,max:1},series:[],graphic:[{type:"text",left:"center",top:"middle",style:{text:"暂无可理解度样本点",fill:"#6b7280",fontSize:13}}]},!0),y.resize(),!0}let a=this.roadSyntaxScatterChart;(!a||a.isDisposed())&&(a=echarts.getInstanceByDom(t)||echarts.init(t),this.roadSyntaxScatterChart=a);const n=this.roadSyntaxRegressionView(),s=Math.min(...i.map(y=>y[0])),d=Math.max(...i.map(y=>y[0])),u=Number.isFinite(n.slope)&&Number.isFinite(n.intercept)?[[s,n.slope*s+n.intercept],[d,n.slope*d+n.intercept]]:[];try{a.setOption({animation:!1,grid:{left:42,right:16,top:20,bottom:34},xAxis:{type:"value",name:"连接度",nameLocation:"middle",nameGap:26,splitLine:{lineStyle:{color:"#eef2f7"}}},yAxis:{type:"value",name:"整合度",nameGap:14,splitLine:{lineStyle:{color:"#eef2f7"}}},series:[{type:"scatter",data:i,symbolSize:6,z:3,itemStyle:{color:"#2563eb",opacity:.82,borderColor:"#ffffff",borderWidth:.8},emphasis:{scale:!1}},{type:"line",data:u,showSymbol:!1,z:2,lineStyle:{width:2,color:"#dc2626",opacity:u.length?.9:0}}],graphic:[]},!0)}catch(y){console.warn("[road-syntax] scatter setOption failed, retry with simplified series",y),a.clear(),a.setOption({animation:!1,grid:{left:42,right:16,top:20,bottom:34},xAxis:{type:"value",name:"连接度",nameLocation:"middle",nameGap:26},yAxis:{type:"value",name:"整合度",nameGap:14},series:[{type:"scatter",data:i,symbolSize:6,itemStyle:{color:"#2563eb",opacity:.85},emphasis:{scale:!1}}],graphic:[]},!0)}return a.resize(),String(this.roadSyntaxStatus||"").indexOf("可理解度样本为空")>=0&&this.roadSyntaxSetStatus(""),!0},normalizeRoadSyntaxScatterPoints(t){const e=Array.isArray(t)?t:[],i=[];if(e.forEach(a=>{let n=NaN,s=NaN;Array.isArray(a)?(n=Number(a[0]),s=Number(a[1])):a&&typeof a=="object"&&(n=Number(a.x),Number.isFinite(n)||(n=Number(a.connectivity_score??a.connectivity??a.degree_score??a.degree)),s=Number(a.y),Number.isFinite(s)||(s=Number(a.integration_global??a.integration_score??a.integration))),Number.isFinite(n)&&Number.isFinite(s)&&i.push([n,s])}),i.length>8e3){const a=Math.max(1,Math.ceil(i.length/8e3));return i.filter((n,s)=>s%a===0)}return i},buildRoadSyntaxScatterFallbackPoints(){let t=[];const e=Array.isArray(this.roadSyntaxNodes)?this.roadSyntaxNodes:[];if(e.length&&(t=e.map(i=>{const a=i&&i.properties||{};return[Number.isFinite(Number(a.degree_score))?Number(a.degree_score):Number(a.degree),Number(a.integration_global)]}).filter(i=>Number.isFinite(i[0])&&Number.isFinite(i[1]))),t.length||(t=(Array.isArray(this.roadSyntaxRoadFeatures)?this.roadSyntaxRoadFeatures:[]).map(a=>{const n=a&&a.properties||{};return[Number(n.connectivity_score),Number(n.integration_global)]}).filter(a=>Number.isFinite(a[0])&&Number.isFinite(a[1]))),t.length>8e3){const i=Math.max(1,Math.ceil(t.length/8e3));t=t.filter((a,n)=>n%i===0)}return t},buildRoadSyntaxRenderItems(t){const e=[];let i=0;const a=[];return(Array.isArray(t)?t:[]).forEach((n,s)=>{const d=this.normalizePath(((n||{}).geometry||{}).coordinates||[],2,"road_syntax.render_items.path");if(!d.length){if(i+=1,a.length<5){const u=(n||{}).properties||{};a.push({idx:s,id:u.edge_id||u.id||"",name:u.name||""})}return}e.push({coords:d,boundsRect:this.buildRoadSyntaxBoundsRect(d),props:(n||{}).properties||{}})}),i>0&&console.warn("[road-syntax] skipped invalid road geometries",{invalid_count:i,total_features:Array.isArray(t)?t.length:0,samples:a}),e},buildRoadSyntaxRenderFingerprint(t){const e=Array.isArray(t)?t:[];if(!e.length)return"0";const i=e[0]||{},a=e[e.length-1]||{},n=this.normalizeLngLat((i.coords||[])[0],"road_syntax.render_fingerprint.first")||[0,0],s=a.coords||[],d=this.normalizeLngLat(s[s.length-1],"road_syntax.render_fingerprint.last")||[0,0];return`${e.length}|${n[0].toFixed(6)},${n[1].toFixed(6)}|${d[0].toFixed(6)},${d[1].toFixed(6)}`},rebuildRoadSyntaxBasePolylines(){return this.roadSyntaxPolylines=[],this.roadSyntaxLayerLodIndexCache={},this.roadSyntaxTargetVisibleLineSet={},this.roadSyntaxAppliedVisibleLineSet={},this.roadSyntaxResetVisibleIndexCache(),this.roadSyntaxResetLodScoreCache(),this.roadSyntaxResetSpatialIndex(),[]},isRoadSyntaxLayerReady(t){if(this.roadSyntaxStrictWebglOnly)return!!(this.roadSyntaxUseArcgisWebgl&&typeof this.roadSyntaxCanUseArcgisWebglPayload=="function"&&this.roadSyntaxCanUseArcgisWebglPayload(this.roadSyntaxWebglPayload));if(this.roadSyntaxUseArcgisWebgl&&typeof this.roadSyntaxCanUseArcgisWebglPayload=="function"&&this.roadSyntaxCanUseArcgisWebglPayload(this.roadSyntaxWebglPayload))return!0;const e=this.roadSyntaxLayerBuildState||{};return!!(this.roadSyntaxLayerStyleCache||{})[t]&&e[t]==="ready"},enqueueRoadSyntaxLayerBuild(t,e={}){if(this.roadSyntaxStrictWebglOnly||!this.roadSyntaxMap()||!window.AMap||!Array.isArray(this.roadSyntaxPolylineItems)||!this.roadSyntaxPolylineItems.length)return;const i=!!(e&&e.priority),a=!!(e&&e.switchOnReady),n=Object.assign({},this.roadSyntaxLayerBuildState||{}),s=Array.isArray(this.roadSyntaxLayerBuildQueue)?this.roadSyntaxLayerBuildQueue.slice():[],d=n[t];if(d==="ready"){a&&(this.roadSyntaxPendingLayerKey=t,this.switchRoadSyntaxLayerByKey(t));return}if(d==="building"||d==="queued"){a&&(this.roadSyntaxPendingLayerKey=t);return}n[t]="queued",i?s.unshift(t):s.push(t),a&&(this.roadSyntaxPendingLayerKey=t),this.roadSyntaxLayerBuildState=n,this.roadSyntaxLayerBuildQueue=s,this.scheduleRoadSyntaxLayerBuilder()},scheduleRoadSyntaxLayerBuilder(){if(this.roadSyntaxLayerBuildRunning)return;const t=Array.isArray(this.roadSyntaxLayerBuildQueue)?this.roadSyntaxLayerBuildQueue:[];if(!t.length)return;const e=t.shift();this.roadSyntaxLayerBuildQueue=t;const i=Object.assign({},this.roadSyntaxLayerBuildState||{});i[e]="building",this.roadSyntaxLayerBuildState=i,this.roadSyntaxLayerBuildRunning=!0;const a=this.roadSyntaxLayerBuildToken+1;this.roadSyntaxLayerBuildToken=a;const n=this.parseRoadSyntaxLayerKey(e),s=n.metric,d=this.resolveRoadSyntaxMetricField(s,n.radiusLabel),u=this.resolveRoadSyntaxFallbackField(s),y=Array.isArray(this.roadSyntaxPolylineItems)?this.roadSyntaxPolylineItems:[],g=[];let S=0;const m=()=>{if(a!==this.roadSyntaxLayerBuildToken)return;if(this.roadSyntaxIsInteractingInMetricView()){window.setTimeout(()=>{a===this.roadSyntaxLayerBuildToken&&window.requestAnimationFrame(m)},60);return}const x=window.performance&&typeof window.performance.now=="function"?()=>window.performance.now():()=>Date.now(),M=x(),k=this.roadSyntaxResolveFrameBudget("layer");for(;S<y.length;){const B=y[S]||{};S+=1;const ut=this.buildRoadSyntaxStyleForMetric(B&&B.props||{},d,u,s,n.skeletonOnly);if(g.push(ut),x()-M>=k)break}if(S<y.length){window.requestAnimationFrame(m);return}const R=Object.assign({},this.roadSyntaxLayerStyleCache||{});R[e]=g,this.roadSyntaxLayerStyleCache=R;const f=this.roadSyntaxMap(),A=Object.assign({},this.roadSyntaxLayerPool||{});A[e]&&this.roadSyntaxDisposeLayerEntry(A[e],f);const L=this.roadSyntaxBuildLayerFromStyles(e,g,{variant:"full"}),P=this.roadSyntaxBuildLayerLodIndexSet(e),C=this.roadSyntaxBuildLayerFromStyles(e,g,{variant:"lod",includeIndexSet:P,zIndexBoost:3});L.lodLayer=C,L.lodIndexSet=this.roadSyntaxCloneIndexSet(C.indexSet||P),A[e]=L,this.roadSyntaxLayerPool=A;const I=Object.assign({},this.roadSyntaxLayerBuildState||{});I[e]="ready",this.roadSyntaxLayerBuildState=I,this.roadSyntaxLayerBuildRunning=!1;const G=this.refreshRoadSyntaxLayerReadyMap(),tt=Object.values(G).filter(B=>!!B).length,H=Object.keys(G).length;if(H>0&&tt>=H){const B=!!this.roadSyntaxPoolDegraded;this.roadSyntaxPoolReady=!0,this.roadSyntaxPoolDegraded=!1,this.roadSyntaxPoolInitRunning&&(this.roadSyntaxPoolInitRunning=!1),B&&this.roadSyntaxUseLegacyPoolStatus()&&this.roadSyntaxSetStatus(this.roadSyntaxFormatReadyStatus("图层补建完成",tt,H))}else this.roadSyntaxPoolInitRunning&&this.roadSyntaxUseLegacyPoolStatus()&&this.roadSyntaxSetStatus(this.roadSyntaxFormatReadyStatus("图层预加载中",tt,H));this.roadSyntaxPendingLayerKey===e&&this.switchRoadSyntaxLayerByKey(e,{force:!0}),this.scheduleRoadSyntaxLayerBuilder()};window.requestAnimationFrame(m)},switchRoadSyntaxLayerByKey(t,e={}){if(!this.roadSyntaxMap())return;const a=!e||e.trackPerf!==!1,n=this.roadSyntaxNow();if(!this.roadSyntaxUseArcgisWebgl){this.roadSyntaxSetStatus("ArcGIS-WebGL 未启用，旧版回退已禁用");return}if(this.roadSyntaxUseArcgisWebgl&&typeof this.roadSyntaxCanUseArcgisWebglPayload=="function"&&this.roadSyntaxCanUseArcgisWebglPayload(this.roadSyntaxWebglPayload)){this.roadSyntaxActiveLayerKey=String(t||this.resolveRoadSyntaxLayerKey(this.resolveRoadSyntaxActiveMetric())),this.roadSyntaxActiveLayerVariant="full",this.roadSyntaxPendingLayerKey="",this.roadSyntaxDisplaySuspended=!1,typeof this.renderRoadSyntaxArcgisWebgl=="function"?this.renderRoadSyntaxArcgisWebgl(this.roadSyntaxWebglPayload,{hideWhenSuspended:!0}).then(s=>{s?a&&this.recordRoadSyntaxSwitchDuration(n,t,0,0,"arcgis_webgl"):this.roadSyntaxStrictWebglOnly&&this.roadSyntaxSetStatus("ArcGIS-WebGL 切换失败（已禁用旧版回退）")}).catch(s=>{console.warn("[road-syntax] arcgis webgl switch render failed",s),this.roadSyntaxStrictWebglOnly&&this.roadSyntaxSetStatus("ArcGIS-WebGL 切换失败（已禁用旧版回退）")}):this.roadSyntaxStrictWebglOnly&&this.roadSyntaxSetStatus("ArcGIS-WebGL 渲染器不可用（已禁用旧版回退）");return}this.roadSyntaxSetStatus(this.buildRoadSyntaxWebglUnavailableMessage(this.roadSyntaxWebglPayload))},warmRoadSyntaxLayerPool(t=""){const e=this.roadSyntaxLayerBuildState||{};this.roadSyntaxLayerKeysForPrebuild().filter(a=>{if(a===t)return!1;const n=e[a];return n!=="ready"&&n!=="building"&&n!=="queued"}).forEach(a=>this.enqueueRoadSyntaxLayerBuild(a,{priority:!1,switchOnReady:!1}))},waitRoadSyntaxLayerReady(t,e=ROAD_SYNTAX_CONST.PREBUILD_DEADLINE_MS){return new Promise(i=>{const a=Date.now(),n=()=>{if(this.isRoadSyntaxLayerReady(t)){i(!0);return}if(Date.now()-a>e){i(!1);return}window.setTimeout(n,25)};n()})},prewarmRoadSyntaxLayerVisibility(t,e=""){return t!==this.roadSyntaxRequestToken?Promise.resolve(!1):Promise.resolve(!0)},prewarmRoadSyntaxSwitchPath(t,e=""){return Promise.resolve(t===this.roadSyntaxRequestToken)},async initializeRoadSyntaxPoolFully(t,e=""){if(this.roadSyntaxStrictWebglOnly)return this.roadSyntaxPoolInitRunning=!1,this.roadSyntaxPoolReady=!0,this.roadSyntaxPoolDegraded=!1,this.roadSyntaxPoolInitTotal=1,this.roadSyntaxPoolInitDone=1,!0;const i=this.roadSyntaxLayerKeysForPrebuild(),a=e?[e].concat(i.filter(S=>S!==e)):i.slice();if(!a.length)return this.roadSyntaxPoolReady=!0,this.roadSyntaxPoolDegraded=!1,!0;const n=Number(this.roadSyntaxPrebuildDeadlineMs||ROAD_SYNTAX_CONST.PREBUILD_DEADLINE_MS),s=Date.now();this.roadSyntaxPoolInitRunning=!0,this.roadSyntaxPoolReady=!1,this.roadSyntaxPoolDegraded=!1,this.roadSyntaxPoolInitTotal=a.length,this.roadSyntaxPoolInitDone=0,this.roadSyntaxUseLegacyPoolStatus()&&this.roadSyntaxSetStatus(this.roadSyntaxFormatReadyStatus("图层预加载中",0,a.length)),this.refreshRoadSyntaxLayerReadyMap(),a.forEach((S,m)=>this.enqueueRoadSyntaxLayerBuild(S,{priority:m===0,switchOnReady:!1}));let d=!1;for(let S=0;S<a.length;S+=1){if(t!==this.roadSyntaxRequestToken)return this.roadSyntaxPoolInitRunning=!1,!1;const m=Date.now()-s,x=n-m;if(x<=0){d=!0;break}if(!await this.waitRoadSyntaxLayerReady(a[S],x)){d=!0;break}this.roadSyntaxPoolInitDone=S+1,this.roadSyntaxUseLegacyPoolStatus()&&this.roadSyntaxSetStatus(this.roadSyntaxFormatReadyStatus("图层预加载中",this.roadSyntaxPoolInitDone,this.roadSyntaxPoolInitTotal))}this.roadSyntaxPoolInitRunning=!1;const u=this.refreshRoadSyntaxLayerReadyMap(),y=Object.values(u).filter(S=>!!S).length,g=y>=a.length;if(this.roadSyntaxPoolReady=g,this.roadSyntaxPoolDegraded=!g,g&&(this.roadSyntaxUseLegacyPoolStatus()&&this.roadSyntaxSetStatus(this.roadSyntaxFormatReadyStatus("图层预加载完成",y,a.length)),this.roadSyntaxEnableHeavyPrewarm)){const S=this.roadSyntaxPrewarmToken+1;this.roadSyntaxPrewarmToken=S,window.setTimeout(async()=>{if(S===this.roadSyntaxPrewarmToken&&t===this.roadSyntaxRequestToken)try{await this.prewarmRoadSyntaxLayerVisibility(t,e||a[0]||""),await this.prewarmRoadSyntaxSwitchPath(t,e||a[0]||"")}catch{}},0)}return!g&&d&&this.roadSyntaxUseLegacyPoolStatus()&&this.roadSyntaxSetStatus(`图层预加载超时，进入降级模式：${y}/${a.length}`),g},renderRoadSyntaxOverlays(t,e={}){if(this.roadSyntaxStrictWebglOnly){this.roadSyntaxSetStatus("ArcGIS-WebGL 模式已启用，旧版图层渲染已禁用");return}if(!this.roadSyntaxMap()||!window.AMap)return;typeof this.clearRoadSyntaxArcgisWebgl=="function"&&this.clearRoadSyntaxArcgisWebgl({dispose:!1});const i=!!(e&&e.forceRebuild),a=!(e&&e.displayActive===!1),n=(t||{}).features||[];if(this.roadSyntaxRoadFeatures=Array.isArray(n)?n:[],!this.roadSyntaxRoadFeatures.length){this.clearRoadSyntaxOverlays();return}const s=this.buildRoadSyntaxRenderItems(this.roadSyntaxRoadFeatures);if(!s.length){this.clearRoadSyntaxOverlays();return}const d=this.buildRoadSyntaxRenderFingerprint(s);(i||!this.roadSyntaxSourceFingerprint||this.roadSyntaxSourceFingerprint!==d||!Object.keys(this.roadSyntaxLayerPool||{}).length)&&(this.roadSyntaxPoolWarmToken+=1,this.roadSyntaxLayerBuildToken+=1,this.roadSyntaxLayerSwitchToken+=1,this.clearRoadSyntaxLayerPool(),this.roadSyntaxPolylineItems=s,this.roadSyntaxSourceFingerprint=d,this.roadSyntaxPoolRadiusLabel=String(this.roadSyntaxRadiusLabel||"global"),this.roadSyntaxPoolReady=!1,this.roadSyntaxPoolDegraded=!1,this.rebuildRoadSyntaxBasePolylines()),this.roadSyntaxResetVisibleIndexCache(),this.roadSyntaxResetLodScoreCache();const y=this.resolveRoadSyntaxActiveMetric(),g=this.resolveRoadSyntaxLayerKey(y);if(a){if(this.isRoadSyntaxLayerReady(g)){const S=this.roadSyntaxResolveDesiredLayerVariant(),m=this.roadSyntaxDisplaySuspended||!this.roadSyntaxGetLayer(g);this.switchRoadSyntaxLayerByKey(g,{force:m,preferVariant:S})}else{this.enqueueRoadSyntaxLayerBuild(g,{priority:!0,switchOnReady:!0});const S=this.roadSyntaxLayerReadyCounts();this.roadSyntaxUseLegacyPoolStatus()&&this.roadSyntaxSetStatus(`图层预处理中：${S.ready}/${S.total||0}`)}this.roadSyntaxLogOverlayHealth("render-road-syntax")}this.warmRoadSyntaxLayerPool(g),this.refreshRoadSyntaxLayerReadyMap(),this.roadSyntaxPolylineItems=s},buildRoadSyntaxRequestPayload(t,e,i=null){const a=this.resolveRoadSyntaxActiveMetric(),n=this.resolveRoadSyntaxMetricField(a,this.roadSyntaxRadiusLabel),s=this.roadSyntaxStrictWebglOnly?!0:!!this.roadSyntaxUseArcgisWebgl,d=a==="control"||a==="depth"||a==="connectivity"||a==="intelligibility",u=this.normalizeRoadSyntaxGraphModel();return{run_id:i?String(i):null,polygon:t,coord_type:"gcj02",mode:"walking",graph_model:u,highway_filter:"all",include_geojson:!0,max_edge_features:d?null:e,merge_geojson_edges:!0,merge_bucket_step:.025,radii_m:[600,800],tulip_bins:1024,metric:this.resolveRoadSyntaxRequestMetric(),use_arcgis_webgl:s,arcgis_timeout_sec:120,arcgis_metric_field:n}},roadSyntaxResponseHasReadyWebgl(t){const e=t&&t.webgl&&typeof t.webgl=="object"?t.webgl:null;return typeof this.roadSyntaxCanUseArcgisWebglPayload!="function"?!1:this.roadSyntaxCanUseArcgisWebglPayload(e)},buildRoadSyntaxWebglUnavailableMessage(t){const e=t&&t.webgl&&typeof t.webgl=="object"?t.webgl:t&&typeof t=="object"?t:null;if(!e||typeof e!="object")return"ArcGIS-WebGL 数据未就绪（已禁用旧版回退）: payload_missing";const i=!!e.enabled,a=String(e&&e.status||"").trim(),n=e&&e.roads&&typeof e.roads=="object"?e.roads:{},s=Array.isArray(n.features)?n.features:[],d=s.length,u=Number(n.count),y=Number.isFinite(u)?u:s.length;return i?a&&a!=="ok"?`ArcGIS-WebGL 数据未就绪（已禁用旧版回退）: ${a}`:d<=0?`ArcGIS-WebGL 数据未就绪（已禁用旧版回退）: features=0, count=${y}`:y<=0?"ArcGIS-WebGL 数据未就绪（已禁用旧版回退）: roads=0":`ArcGIS-WebGL 数据未就绪（已禁用旧版回退）: payload_invalid(status=${a||"empty"}, features=${d}, count=${y})`:a?`ArcGIS-WebGL 数据未就绪（已禁用旧版回退）: enabled=false, status=${a}, features=${d}, count=${y}`:`ArcGIS-WebGL 数据未就绪（已禁用旧版回退）: enabled=false, features=${d}, count=${y}`},applyRoadSyntaxResponseData(t,e="connectivity"){if(this.roadSyntaxRoadFeatures=Array.isArray(t&&t.roads&&t.roads.features||[])?t.roads.features:[],this.roadSyntaxNodes=Array.isArray(t&&t.nodes&&t.nodes.features||[])?t.nodes.features:[],this.roadSyntaxDiagnostics=t&&t.diagnostics?t.diagnostics:null,this.roadSyntaxScatterPointsCache=this.normalizeRoadSyntaxScatterPoints(this.roadSyntaxDiagnostics&&this.roadSyntaxDiagnostics.intelligibility_scatter),this.roadSyntaxSummary=t&&t.summary?t.summary:null,this.roadSyntaxWebglPayload=t&&t.webgl&&typeof t.webgl=="object"?t.webgl:null,this.roadSyntaxWebglStatus=String(this.roadSyntaxWebglPayload&&this.roadSyntaxWebglPayload.status||""),this.roadSyntaxWebglRadiusFilterCache=null,this.roadSyntaxSkeletonOnly=!1,!this.roadSyntaxSummary)return;const n=this.roadSyntaxMetricTabs().map(u=>u.value).includes(e)?e:this.roadSyntaxDefaultMetric();this.roadSyntaxMetric=n,this.roadSyntaxLastMetricTab=n;const s=this.roadSyntaxRadiusOptions(),d=s.some(u=>String(u.value||"")==="global");this.roadSyntaxRadiusLabel=d?"global":String(s[0]&&s[0].value||"global")},buildRoadSyntaxCompletionStatus(t){if(!this.roadSyntaxSummary)return"完成：未返回有效汇总数据";const e=this.roadSyntaxSummary.analysis_engine||"depthmapxcli",i=`完成：${this.roadSyntaxSummary.node_count||0} 节点，${this.roadSyntaxSummary.edge_count||0} 边段（${e}`,a=Number(this.roadSyntaxSummary.control_valid_count||0),n=Number(this.roadSyntaxSummary.depth_valid_count||0),s=String(this.roadSyntaxSummary.control_source_column||""),d=String(this.roadSyntaxSummary.depth_source_column||"");let u="";(a<=0||n<=0)&&(u=`；control=${a}${s?`(${s})`:""}, depth=${n}${d?`(${d})`:""}`);const y=this.roadSyntaxUseArcgisWebgl&&typeof this.roadSyntaxCanUseArcgisWebglPayload=="function"&&this.roadSyntaxCanUseArcgisWebglPayload(this.roadSyntaxWebglPayload);return(typeof this.roadSyntaxIsArcgisWebglActive=="function"?this.roadSyntaxIsArcgisWebglActive():y&&!!this.roadSyntaxWebglActive)?`${i}，ArcGIS-WebGL 已就绪${u}）`:y?`${i}，ArcGIS 数据已返回，但 WebGL 渲染未激活${u}）`:`${i}，ArcGIS-WebGL 未就绪（已禁用旧版回退${u}）`},async computeRoadSyntax(){if(!this.lastIsochroneGeoJSON||this.isComputingRoadSyntax)return;this.roadSyntaxMainTab!=="params"&&this.setRoadSyntaxMainTab("params",{refresh:!1,syncMetric:!1}),this.roadSyntaxStrictWebglOnly&&(this.roadSyntaxUseArcgisWebgl=!0),this.isComputingRoadSyntax=!0;const t=this.roadSyntaxGraphModelLabel();this.roadSyntaxSetStatus(`正在请求路网并计算路网指标（${t}）...`);const e=this.roadSyntaxRequestToken+1;this.roadSyntaxRequestToken=e;const i=this.roadSyntaxCreateRunId();this.roadSyntaxStartProgressTracking(i,e,`局部任务已启动（${t}），正在准备路网`);const a=this.roadSyntaxLastMetricTab||this.roadSyntaxMetric||this.roadSyntaxDefaultMetric();this.cancelRoadSyntaxRequest("start_new_compute");const n=new AbortController;this.roadSyntaxFetchAbortController=n;try{const s=this.getIsochronePolygonPayload();if(!s.length)throw new Error("等时圈范围无效");this.invalidateRoadSyntaxCache("recompute-road-syntax",{resetData:!1,resetPerf:!0}),this.roadSyntaxSummary=null,this.roadSyntaxRoadFeatures=[],this.roadSyntaxNodes=[],this.roadSyntaxDiagnostics=null,this.roadSyntaxLegendModel=null;const d=this.resolveRoadSyntaxEdgeCap(),u=this.buildRoadSyntaxRequestPayload(s,d,i),y=await this.fetchRoadSyntaxApi(u,{signal:n.signal});if(e!==this.roadSyntaxRequestToken)return;if(this.roadSyntaxRadiusLabel="global",this.applyRoadSyntaxResponseData(y,a),!(this.roadSyntaxUseArcgisWebgl&&typeof this.roadSyntaxCanUseArcgisWebglPayload=="function"&&this.roadSyntaxCanUseArcgisWebglPayload(this.roadSyntaxWebglPayload)))throw new Error(this.buildRoadSyntaxWebglUnavailableMessage(y));let S=!1;try{if(typeof this.renderRoadSyntaxArcgisWebgl!="function")throw new Error("ArcGIS-WebGL 渲染器不可用");S=await this.renderRoadSyntaxArcgisWebgl(this.roadSyntaxWebglPayload,{hideWhenSuspended:!0})}catch(x){console.warn("[road-syntax] arcgis webgl initial render failed",x),S=!1}if(!S){const x=String(this.roadSyntaxWebglStatus||"").trim();throw new Error(x?`ArcGIS-WebGL 渲染失败（已禁用旧版回退）: ${x}`:"ArcGIS-WebGL 渲染失败（已禁用旧版回退）")}this.roadSyntaxPoolReady=!0,this.roadSyntaxPoolDegraded=!1,this.roadSyntaxPoolInitRunning=!1,this.roadSyntaxPoolInitTotal=1,this.roadSyntaxPoolInitDone=1;const m=!0;this.roadSyntaxSummary&&(this.setRoadSyntaxMainTab(this.roadSyntaxLastMetricTab||this.roadSyntaxDefaultMetric(),{refresh:!1,syncMetric:!0}),this.activeStep3Panel==="syntax"?await this.renderRoadSyntaxByMetric(this.roadSyntaxLastMetricTab||this.roadSyntaxMetric||this.roadSyntaxDefaultMetric()):typeof this.suspendRoadSyntaxDisplay=="function"&&this.suspendRoadSyntaxDisplay()),this.roadSyntaxSetStatus(`局部（当前多边形）${this.buildRoadSyntaxCompletionStatus(m)}`),typeof this.saveAnalysisHistoryAsync=="function"&&this.saveAnalysisHistoryAsync(this.getIsochronePolygonPayload(),typeof this.buildSelectedCategoryBuckets=="function"?this.buildSelectedCategoryBuckets():[],this.allPoisDetails)}catch(s){if(e!==this.roadSyntaxRequestToken)return;if(s&&(s.name==="AbortError"||String(s.message||"").indexOf("aborted")>=0)){this.roadSyntaxSetStatus("已取消旧请求，正在使用最新参数计算...");return}console.error(s);const d=s&&s.message?s.message:String(s);if(typeof d=="string"&&(d.indexOf("Overpass query timeout/error")>=0||d.indexOf("Local Overpass request failed")>=0)){this.roadSyntaxSetStatus("失败: 路网抓取超时（Overpass 忙），请等几秒再试，或缩小等时圈范围后重试。");return}if(this.normalizeRoadSyntaxGraphModel()==="axial"){const y=String(d||"").trim();y.startsWith("轴线图计算失败")?this.roadSyntaxSetStatus(`失败: ${y}`):this.roadSyntaxSetStatus(`失败: 轴线图计算失败：${y||"请改用线段图或缩小范围后重试。"}`)}else this.roadSyntaxSetStatus("失败: "+d)}finally{this.roadSyntaxFetchAbortController===n&&(this.roadSyntaxFetchAbortController=null),this.isComputingRoadSyntax=!1,this.roadSyntaxStopProgressTracking()}},renderResult(t){if(!t||!t.geometry){this.errorMessage="未获取到有效数据";return}this.clearIsochroneDebugState(),this.lastIsochroneGeoJSON=t,this.applySimplifyConfig()}}});de({app:X,pinia:l,target:"#analysis-app-root"})}function ye(){return he()}function ue(){if(typeof window>"u"||window.__ANALYSIS_CANVAS_READBACK_PATCHED__)return;const r=window.HTMLCanvasElement&&window.HTMLCanvasElement.prototype;if(!r||typeof r.getContext!="function")return;const o=r.getContext;r.getContext=function(h,c){if(h==="2d"){const p=c&&typeof c=="object"?c:{};return o.call(this,h,{...p,willReadFrequently:!0})}return o.call(this,h,c)},window.__ANALYSIS_CANVAS_READBACK_PATCHED__=!0}async function pe(r){ue(),await Ut();const o=document.getElementById("analysis-app-root");if(!o)throw new Error("analysis app root not found");if(window.__ANALYSIS_BOOTSTRAP__=r,!window.__ANALYSIS_APP_MOUNTED__){o.innerHTML=`<div class="analysis-layout-root">${Qt}</div>`,ye(),window.__ANALYSIS_APP_MOUNTED__=!0;return}window.location.reload()}const Se={class:"analysis-shell"},ge={key:0,class:"state state-overlay"},me={key:1,class:"state state-error"},xe=Ht({__name:"App",setup(r){const o=dt(!0),l=dt("");return zt(async()=>{try{const h=await fetch("/api/v1/config");if(!h.ok)throw new Error(`/api/v1/config 请求失败(${h.status})`);const c=await h.json();await pe({config:{amap_js_api_key:String((c==null?void 0:c.amap_js_api_key)||""),amap_js_security_code:String((c==null?void 0:c.amap_js_security_code)||""),tianditu_key:String((c==null?void 0:c.tianditu_key)||"")},typeMapConfig:(c==null?void 0:c.map_type_config_json)||{groups:[]}})}catch(h){const c=h instanceof Error?h.message:String(h);l.value=`初始化失败：${c}`}finally{o.value=!1}}),(h,c)=>(et(),at("main",Se,[c[0]||(c[0]=jt("div",{id:"analysis-app-root",class:"analysis-host"},null,-1)),o.value?(et(),at("div",ge,"正在初始化分析工作台...")):l.value?(et(),at("div",me,Vt(l.value),1)):qt("",!0)]))}}),be=(r,o)=>{const l=r.__vccOpts||r;for(const[h,c]of o)l[h]=c;return l},fe=be(xe,[["__scopeId","data-v-3a0acfa8"]]);yt(fe).mount("#app");
