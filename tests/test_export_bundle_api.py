...
from modules.export_bundle.schemas import AnalysisExportBundleRequest
from router.app import export_analysis_bundle
...
def test_export_bundle_h3_gpkg_success(monkeypatch):
    ...
    monkeypatch.setattr("modules.export_bundle.builder.run_arcgis_h3_export", _fake_export)
